...
;	
;	+ 00:	x min 19 max D8 1 block = $8
;	+ 01:	y min 11 max F0 1 block = $10
;	+ 03:	snobee color
;	+ 04:	direction (0 up, 1 down, 2 left, 3 right
...
0068: 2A 22 88      ld   hl,($8822)
006B: 23            inc  hl
006C: 22 22 88      ld   ($8822),hl
...
009D: 34            inc  (hl)
009E: 3E 20         ld   a,$00
00A0: DD 21 60 8C   ld   ix,$8C60
00A4: CD 99 BA      call $1A99
00A7: 3E 29         ld   a,$01
00A9: DD 21 70 8C   ld   ix,$8C70
00AD: CD 99 92      call $1A99
00B0: 3E 23         ld   a,$03
00B2: DD 21 90 AC   ld   ix,$8C90
00B6: CD B9 1A      call $1A99
00B9: 3E 02         ld   a,$02
00BB: DD 21 28 8C   ld   ix,$8C80
00BF: CD 99 92      call $1A99
00C2: 3E A4         ld   a,$04
00C4: DD 21 00 8C   ld   ix,$8CA0
00C8: CD 99 BA      call $1A99
00CB: 21 20 8F      ld   hl,$8F20
00CE: 3A 1C 8C      ld   a,($8CBC)
00D1: A7            and  a
00D2: 28 23         jr   z,$00D7
00D4: 21 80 8F      ld   hl,$8F28
00D7: 11 06 AF      ld   de,$8F06
00DA: 01 25 00      ld   bc,$0005
00DD: ED B0         ldir
00DF: 7E            ld   a,(hl)
00E0: 32 B1 8F      ld   ($8F11),a
00E3: 21 30 8F      ld   hl,$8F30
00E6: 3A 1D 8C      ld   a,($8CBD)
00E9: A7            and  a
00EA: 28 A3         jr   z,$00EF
00EC: 21 10 8F      ld   hl,$8F38
00EF: 11 0B AF      ld   de,$8F0B
00F2: 01 25 00      ld   bc,$0005
00F5: ED B0         ldir
00F7: 7E            ld   a,(hl)
00F8: 32 32 8F      ld   ($8F12),a
00FB: 21 BF AC      ld   hl,$8CBF
00FE: CB 46         bit  0,(hl)
0100: 28 A5         jr   z,$010F
0102: CB 86         res  0,(hl)
0104: 21 80 87      ld   hl,$8F00
0107: 11 B8 10      ld   de,$9010
010A: 01 90 A8      ld   bc,$0010
010D: ED B0         ldir
010F: 3A 10 8F      ld   a,($8F10)
0112: CB 7F         bit  7,a
0114: 28 80         jr   z,$011E
0116: E6 A7         and  $07
0118: 32 B0 8F      ld   ($8F10),a
011B: 32 05 B8      ld   ($9005),a
011E: 3A B1 87      ld   a,($8F11)
0121: CB 7F         bit  7,a
0123: 28 88         jr   z,$012D
0125: E6 AF         and  $07
0127: 32 B9 27      ld   ($8F11),a
012A: 32 A2 B0      ld   ($900A),a
012D: 3A BA 27      ld   a,($8F12)
0130: CB 7F         bit  7,a
...
01B8: 31 78 8F      ld   sp,$8FF0
01BB: 21 C7 A1      ld   hl,$01C7
01BE: E5            push hl
01BF: 3E A9         ld   a,$01
01C1: 32 E8 10      ld   (dip_switches_9040),a
01C4: FB            ei
01C5: ED 4D         reti
01C7: CD 65 A8      call $28E5
01CA: CD 1F 39      call $31B7
01CD: 21 56 81      ld   hl,$01FE
01D0: CD 7C 29      call $29F4
01D3: CD F4 01      call $29F4
01D6: 21 94 02      ld   hl,$021C
01D9: CD F4 01      call $29F4
01DC: CD 7C 29      call $29F4
01DF: 21 1D 82      ld   hl,$023D
01E2: CD 5C 09      call $29F4
01E5: CD 74 A9      call $29F4
...
01FF: A2            and  d
0200: B8            cp   b
0201: E4 E9 F2      call po,$5249
0204: 6D            ld   l,l
0205: E3            ex   (sp),hl
0206: 7C            ld   a,h
0207: E5            push hl
0208: 6C            ld   l,h
0209: 20 6A         jr   nz,$024D
020B: D9            exx
020C: 2B            dec  hl
020D: A4            and  h
020E: 38 C6         jr   c,$025E
0210: 4F            ld   c,a
0211: 62            ld   h,d
0212: 55            ld   d,l
0213: E7            rst  $20
0214: 20 00         jr   nz,$0236
0216: 4B            ld   c,e
0217: E7            rst  $20
0218: 44            ld   b,h
0219: 65            ld   h,l
...
0221: C7            rst  $00
0222: 6F            ld   l,a
0223: F2 69 C5      jp   p,$4D41
0226: 6D            ld   l,l
0227: E4 20 E2      call po,$4220
022A: D9            exx
022B: A3            and  e
022C: AD            xor  l
022D: B0            or   b
022E: 69            ld   l,c
022F: C3 49 72      jp   $5249
0232: 41            ld   b,c
0233: 00            nop
0234: 20 E6         jr   nz,$0284
0236: 41            ld   b,c
0237: E3            ex   (sp),hl
0238: 41            ld   b,c
0239: E3            ex   (sp),hl
...
0251: E6 4A         and  $4A
0253: E1            pop  hl
0254: 20 00         jr   nz,$0276
0256: 45            ld   b,l
0257: 67            ld   h,a
0258: C9            ret
0259: 22 1E 30      ld   ($101E),hl
025C: 43            ld   b,e
025D: E7            rst  $20
025E: 52            ld   d,d
025F: 65            ld   h,l
0260: EC E1 EE      call pe,$4E41
0263: E4 20 F4      call po,$5420
0266: 6D            ld   l,l
0267: E3            ex   (sp),hl
0268: E8            ret  pe
0269: C6 EF         add  a,$4F
026B: C4 EF E7      call nz,$474F
026E: F9            ld   sp,hl
026F: 20 49         jr   nz,$02BA
0271: E6 43         and  $43
0273: 9A            sbc  a,d
0274: 12            ld   (de),a
0275: 00            nop
...
0278: 39            add  hl,sp
0279: 90            sub  b
027A: 32 92 39      ld   ($393A),a
027D: 92            sub  d
027E: B1            or   c
027F: 3A 48 B8      ld   a,($90C0)
0282: 2F            cpl
0283: E6 68         and  $40
0285: C8            ret  z
0286: 06 A0         ld   b,$00
...
028C: 3A E8 18      ld   a,($90C0)
028F: 2F            cpl
0290: E6 60         and  $40
0292: C8            ret  z
0293: 3A C0 38      ld   a,($90C0)
0296: 2F            cpl
0297: E6 40         and  $40
0299: 20 F8         jr   nz,$0293
029B: 21 08 A8      ld   hl,$8808
029E: 34            inc  (hl)
029F: C3 8B A3      jp   $038B
02A2: 21 30 88      ld   hl,$8830
02A5: 06 38         ld   b,$10
...
02B4: 00            nop
02B5: 00            nop
02B6: 3A 68 90      ld   a,($90C0)
02B9: 2F            cpl
02BA: E6 30         and  $10
02BC: 20 D8         jr   nz,$02B6
02BE: 21 B4 88      ld   hl,$881C
02C1: 34            inc  (hl)
02C2: 21 81 88      ld   hl,$8809
02C5: 3A 28 B8      ld   a,($9000)
02C8: 2F            cpl
02C9: E6 AF         and  $0F
02CB: 18 B2         jr   $0307
02CD: 21 31 88      ld   hl,$8831
02D0: 06 00         ld   b,$20
...
02DF: 00            nop
02E0: 00            nop
02E1: 3A 48 B8      ld   a,($90C0)
02E4: 2F            cpl
02E5: E6 20         and  $20
02E7: 20 D0         jr   nz,$02E1
02E9: 21 BE 88      ld   hl,$881E
02EC: 34            inc  (hl)
02ED: 21 AA 88      ld   hl,$880A
02F0: 3A 20 90      ld   a,($9000)
02F3: 2F            cpl
02F4: E6 A7         and  $0F
02F6: 47            ld   b,a
02F7: 3A 00 38      ld   a,($9000)
02FA: 2F            cpl
02FB: 0F            rrca
02FC: 0F            rrca
02FD: 0F            rrca
...
0339: 65            ld   h,l
033A: 03            inc  bc
033B: F2 03 57      jp   p,$7F03
033E: 03            inc  bc
033F: D7            rst  $10
0340: AB            xor  e
0341: EC AB D6      call pe,$5603
0344: AB            xor  e
0345: DF            rst  $18
0346: AB            xor  e
0347: F3            di
...
0370: 02            ld   (bc),a
0371: 5F            ld   e,a
0372: 01 A1 01      ld   bc,$0101
0375: A1            and  c
0376: 02            ld   (bc),a
0377: 5F            ld   e,a
0378: 01 A1 01      ld   bc,$0101
037B: A2            and  d
037C: FF            rst  $38
037D: A1            and  c
037E: 02            ld   (bc),a
...
03AD: 11 ED 10      ld   de,$9045
03B0: 18 A6         jr   $03B8
03B2: 21 94 88      ld   hl,$881C
03B5: 11 44 B8      ld   de,$9044
03B8: 7E            ld   a,(hl)
03B9: A7            and  a
03BA: C8            ret  z
03BB: 23            inc  hl
...
03E2: 32 C1 B0      ld   ($9041),a
03E5: 32 EB 10      ld   ($9043),a
03E8: 32 C4 B0      ld   ($9044),a
03EB: 32 ED 10      ld   ($9045),a
03EE: 32 C7 90      ld   ($9047),a
03F1: 32 42 B8      ld   ($9042),a
03F4: 32 E6 90      ld   ($9046),a
03F7: AF            xor  a
03F8: 21 A0 00      ld   hl,$0000
03FB: 32 08 88      ld   ($8808),a
03FE: 22 81 88      ld   ($8809),hl
0401: 32 AB 88      ld   ($880B),a
0404: 22 94 88      ld   ($881C),hl
0407: 22 BE 88      ld   ($881E),hl
040A: 21 60 8C      ld   hl,$8C60
040D: 11 61 8C      ld   de,$8C61
0410: 01 F7 00      ld   bc,$005F
0413: 36 00         ld   (hl),$00
0415: ED B0         ldir
0417: 21 00 AF      ld   hl,$8F00
041A: 11 21 8F      ld   de,$8F01
041D: 01 3F 20      ld   bc,$003F
0420: 36 A0         ld   (hl),$00
0422: ED B0         ldir
0424: CD 4C B8      call $18EC
0427: AF            xor  a
...
0430: FB            ei
0431: AF            xor  a
0432: 32 80 88      ld   ($8828),a
0435: 32 29 A8      ld   ($8829),a
0438: 21 20 00      ld   hl,$0000
043B: 22 0E A8      ld   ($880E),hl
043E: 22 30 88      ld   ($8810),hl
0441: 21 58 A7      ld   hl,$07D0
0444: 22 84 88      ld   ($880C),hl
0447: CD 68 25      call $2540
...
0454: 06 21         ld   b,$01
0456: 78            ld   a,b
0457: 32 18 A8      ld   ($8818),a
045A: 3E 20         ld   a,$00
045C: 32 37 88      ld   ($8817),a
...
046D: E5            push hl
046E: C1            pop  bc
046F: 2A 28 A8      ld   hl,($8828)
0472: CD 30 05      call $0510
0475: 32 2A A8      ld   ($882A),a
	
loop_0478: 3E 20         ld   a,$00
047A: 32 B1 88      ld   (currently_playing_8819),a
047D: CD A0 24      call display_thanks_for_playing_04A0

	;;; loop
	
loop_0480: CD 21 2D      call display_title_screen_0521
0483: CD CB 22      call banquise_screen_22CB
...
0543: 21 B0 85      ld   hl,$0590 ; pengo
0546: CD 5C 09      call print_line_29F4
0549: 21 90 85      ld   hl,$0598 ; snobee
...
06EC: 22 24 88      ld   (counter_8824),hl
...
070D: 22 2E 20      ld   ($random_seed_8826),hl
	;; demo sequence 1
0710: 11 A0 64      ld   de,$6400
0713: 21 F6 8C      ld   hl,$8CF6
0716: 34            inc  (hl)
0717: CB 46         bit  0,(hl)
0719: 28 03         jr   z,$071E
	;; demo sequence 2
071B: 11 00 66      ld   de,$6600
...
0774: CD 3F 31      call $31B7
	;; initialize pengo structure
	;; init pengo structure
0777: DD 21 A8 8D   ld   ix,pengo_struct_8D80
077B: DD 36 A0 B0   ld   (ix+$00),$B0 ; 176
077F: DD 36 81 D8   ld   (ix+$01),$58 ; 88
0783: DD 36 83 8B   ld   (ix+$03),$0B
0787: DD 36 84 AA   ld   (ix+$04),$02
078B: DD 36 85 AD   ld   (ix+$05),$05
078F: DD 36 81 00   ld   (ix+$09),$00
0793: DD 36 83 00   ld   (ix+$0b),$00
0797: CD CE 33      call $33CE
079A: CD 0B 39      call $39AB
...
07D4: 2F            cpl
07D5: E6 0F         and  $0F
07D7: 21 09 88      ld   hl,$8809
07DA: CD 5B 07      call $07FB
07DD: 21 0A 88      ld   hl,$880A
07E0: 3A 80 B0      ld   a,($9000)
07E3: 2F            cpl
07E4: E6 A7         and  $0F
07E6: 47            ld   b,a
07E7: 3A A8 10      ld   a,($9000)
07EA: 2F            cpl
07EB: 0F            rrca
07EC: 0F            rrca
07ED: 0F            rrca
...
081C: 11 02 08      ld   de,$0822
081F: C3 8F 05      jp   indirect_jump_2D8F
0822: D2 17 30      jp   nc,$303F
0825: 80            add  a,b
0826: FC 80 BF      call m,$1F08
0829: E0            ret  po
082A: 6E            ld   l,(hl)
082B: 80            add  a,b
082C: FC 80 70      call m,$7008
082F: 80            add  a,b
0830: 26 A4         ld   h,$0C
0832: 2E 33         ld   l,$13
...
increase_counter_0875: 2A 24 A8      ld   hl,(counter_8824)
0878: 23            inc  hl
0879: 22 24 A8      ld   (counter_8824),hl
087C: C9            ret
...
09DD: 23            inc  hl
09DE: 77            ld   (hl),a
09DF: 21 D6 25      ld   hl,$8DDE
09E2: 36 A0         ld   (hl),$08
09E4: 23            inc  hl
09E5: 36 A0         ld   (hl),$80
	
main_game_loop_09E7: 3A 68 24      ld   a,($8C60)
09EA: A7            and  a
...
0A48: 3A D5 8C      ld   a,(elapsed_minutes_8C5D)
...
0C59: DD 7E 20      ld   a,(ix+$00)
0C5C: DD 36 04 22   ld   (ix+$04),$02
0C60: FE A8         cp   $80
0C62: 30 A4         jr   nc,$0C68
0C64: DD 36 2C A3   ld   (ix+$04),$03
0C68: DD 36 2E 87   ld   (ix+$06),$0F
...
0C7A: DD 34 07      inc  (ix+$07)
0C7D: DD 7E 27      ld   a,(ix+$07)
0C80: DD BE 2E      cp   (ix+$06)
0C83: 38 C3         jr   c,$0C70
0C85: DD 36 A7 28   ld   (ix+$07),$00
0C89: DD 7E A0      ld   a,(ix+$00)
0C8C: A7            and  a
0C8D: C8            ret  z
0C8E: FE C8         cp   $C8
0C90: CC 08 0C      call z,$0CA0
0C93: DD 7E 20      ld   a,(ix+$00)
0C96: FE 80         cp   $28
0C98: CC 99 0C      call z,$0CB9
0C9B: CD D7 95      call $3DD7
0C9E: 18 78         jr   $0C70
0CA0: DD 7E 2C      ld   a,(ix+$04)
0CA3: FE 2B         cp   $03
0CA5: C0            ret  nz
...
0CE6: CD 3B B7      call $3FB3
0CE9: 3E 2E         ld   a,$06
0CEB: DD BE 97      cp   (ix+$1f)
0CEE: 28 7A         jr   z,$0CE2
0CF0: F3            di
0CF1: DD 21 28 8D   ld   ix,pengo_struct_8D80
0CF5: 3A 5C AC      ld   a,($8C5C)
...
0D08: 3A F5 84      ld   a,(elapsed_minutes_8C5D)
...
0D81: 87            add  a,a
0D82: 87            add  a,a
0D83: DD 77 80      ld   (ix+$00),a
0D86: 78            ld   a,b
0D87: 87            add  a,a
0D88: 87            add  a,a
0D89: 87            add  a,a
0D8A: DD 77 A9      ld   (ix+$01),a
0D8D: DD 36 82 08   ld   (ix+$02),$08
0D91: DD 36 96 00   ld   (ix+$1e),$00
0D95: DD 36 97 01   ld   (ix+$1f),$01
0D99: C9            ret
0D9A: E1            pop  hl
0D9B: 18 D0         jr   $0D6D
0D9D: 85            add  a,l
...
0DB0: 50            ld   d,b
0DB1: 59            ld   e,c
0DB2: 2A 38 8D      ld   hl,($8DB0)
0DB5: CD 99 05      call $2D99
0DB8: 28 B3         jr   z,$0DCD
0DBA: 2A 3A 8D      ld   hl,($8DB2)
0DBD: CD 99 05      call $2D99
0DC0: 28 A3         jr   z,$0DCD
0DC2: 2A 1C 85      ld   hl,($8DB4)
0DC5: CD 91 AD      call $2D99
...
0E1B: 87            add  a,a
0E1C: 87            add  a,a
0E1D: DD 77 20      ld   (ix+$00),a
0E20: 78            ld   a,b
0E21: 87            add  a,a
0E22: 87            add  a,a
0E23: 87            add  a,a
0E24: DD 77 29      ld   (ix+$01),a
0E27: CD CE 33      call $33CE
0E2A: E1            pop  hl
0E2B: C9            ret
0E2C: 29            add  hl,hl
0E2D: A2            and  d
0E2E: 2A 91 1E      ld   hl,($1E19)
0E31: DE 19         sbc  a,$19
0E33: 22 02 21      ld   ($0102),hl
0E36: 1E DE         ld   e,$FE
...
0F53: B0            or   b
0F54: 50            ld   d,b
0F55: C4 41 D1      call nz,$5941
0F58: 45            ld   b,l
0F59: F2 20 20      jp   p,$2020
0F5C: B1            or   c
0F5D: 81            add  a,c
0F5E: 0D            dec  c
0F5F: B0            or   b
0F60: F8            ret  m
0F61: E4 E9 F1      call po,$5941
0F64: ED D2         db   $ed,$d2
0F66: 28 88         jr   z,$0F88
0F68: 32 A1 8F      ld   ($0F09),a
0F6B: 90            sub  b
0F6C: EF            rst  $28
0F6D: C1            pop  bc
0F6E: CD C5 20      call $2045
0F71: 20 4F         jr   nz,$0FC2
0F73: F6 45         or   $45
...
0FE5: 90            sub  b
0FE6: F8            ret  m
0FE7: E4 E9 F1      call po,$5941
0FEA: ED D2         db   $ed,$d2
0FEC: 28 19         jr   z,$0F9F
0FEE: 8A            adc  a,d
0FEF: 91            sub  c
0FF0: 10 F0         djnz $1042
0FF2: 4C            ld   c,h
0FF3: E1            pop  hl
0FF4: 59            ld   e,c
0FF5: E5            push hl
0FF6: 52            ld   d,d
0FF7: 20 B2         jr   nz,$0FAB
0FF9: 83            add  a,e
0FFA: 13            inc  de
0FFB: B0            or   b
0FFC: 52            ld   d,d
0FFD: E5            push hl
0FFE: 41            ld   b,c
0FFF: E4 F1 77      call po,$FFD9
1002: FF            rst  $38
1003: 3E 00         ld   a,$00
1005: 32 47 B8      ld   ($9047),a
1008: 32 CA 90      ld   ($9042),a
100B: 32 46 B8      ld   ($9046),a
100E: CD 7A 18      call $18F2
1011: CD B7 B9      call $31B7
1014: CD C9 10      call $1041
1017: CD 3B 98      call $103B
101A: CD 9C 13      call $1314
101D: CD 3B 98      call $103B
1020: CD 79 14      call $14F1
1023: CD 3B 98      call $103B
1026: CD 4E 14      call $1466
1029: CD 3B 98      call $103B
102C: CD 85 11      call $110D
102F: CD 3B 98      call $103B
...
1080: C9            ret
1081: 80            add  a,b
1082: 22 98 52      ld   ($5210),hl
1085: C9            ret
1086: 65            ld   h,l
1087: DB 08         in   a,($20)
1089: 08            ex   af,af'
108A: 08            ex   af,af'
108B: DC 45 DB      call c,$5345
108E: D4 80 12      call nc,$1208
1091: 98            sbc  a,b
1092: 41            ld   b,c
1093: 4C            ld   c,h
1094: 4C            ld   c,h
...
10A2: 65            ld   h,l
10A3: DB 08         in   a,($20)
10A5: CA 41 EC      jp   z,$C441
10A8: 20 85         jr   nz,$10B7
10AA: 10 DA         djnz $10FE
10AC: 41            ld   b,c
10AD: C5            push bc
10AE: 19            add  hl,de
10AF: 08            ex   af,af'
...
10B6: 41            ld   b,c
10B7: 4D            ld   c,l
10B8: 31 A8 42      ld   sp,$4220
10BB: C9            ret
10BC: C4 08 0F      call nz,$0F08
10BF: 98            sbc  a,b
10C0: 52            ld   d,d
10C1: C9            ret
10C2: 65            ld   h,l
...
10CD: 1A            ld   a,(de)
10CE: 08            ex   af,af'
10CF: CA 41 C4      jp   z,$C441
10D2: 21 20 10      ld   hl,$10A8
10D5: CB 41         bit  0,c
10D7: 28 03         jr   z,$10DC
10D9: 21 B2 98      ld   hl,$10B2
10DC: C5            push bc
10DD: CD F4 29      call print_line_29F4
10E0: C1            pop  bc
10E1: C9            ret
10E2: 21 35 10      ld   hl,$10BD
10E5: CB 49         bit  1,c
10E7: 28 03         jr   z,$10EC
10E9: 21 C7 98      ld   hl,$10C7
10EC: C5            push bc
...
110B: AF            xor  a
110C: C9            ret
110D: CD 65 A0      call $28E5
1110: 21 B6 12      ld   hl,$121E
...
120E: 19            add  hl,de
120F: 1E 4D         ld   e,$4D
1211: CA 4D CA      jp   z,$424D
1214: 4D            ld   c,l
1215: CA 4D CA      jp   z,$424D
1218: 4D            ld   c,l
1219: CA 4D CA      jp   z,$424D
121C: 4D            ld   c,l
121D: CA 08 8C      jp   z,$0408
1220: 10 CC         djnz $1266
1222: 61            ld   h,c
1223: D8            ret  c
1224: 08            ex   af,af'
1225: DB 57         in   a,($57)
...
1228: 54            ld   d,h
1229: CB 60         bit  4,b
122B: CD D3 80      call $08D3
122E: 06 98         ld   b,$10
1230: 31 A8 32      ld   sp,$3220
1233: A8            xor  b
1234: 33            inc  sp
1235: A8            xor  b
1236: 34            inc  (hl)
...
123E: B8            cp   b
123F: 8C            adc  a,h
1240: 20 98         jr   nz,$1252
1242: 19            add  hl,de
1243: DB 57         in   a,($57)
1245: 28 04         jr   z,$124B
1247: 82            add  a,d
1248: 10 1A         djnz $127C
124A: 53            ld   d,e
124B: DF            rst  $18
124C: 88            adc  a,b
124D: 8C            adc  a,h
...
124F: 90            sub  b
1250: 44            ld   b,h
1251: CD 4D 4F      call $4F4D
1254: 20 DB         jr   nz,$12A9
1256: 4F            ld   c,a
1257: DD 4E CC      ld   c,(ix+$44)
125A: 53            ld   d,e
125B: A8            xor  b
125C: 4F            ld   c,a
125D: 46            ld   b,(hl)
125E: 10 0F         djnz $126F
1260: 30 C7         jr   nc,$12B1
1262: 46            ld   b,(hl)
1263: EE 04         xor  $04
1265: 99            sbc  a,c
1266: 10 DC         djnz $12BC
1268: 41            ld   b,c
1269: CA 64 CD      jp   z,$454C
126C: 08            ex   af,af'
126D: DC 71 D8      call c,$5059
1270: C5            push bc
1271: 8C            adc  a,h
1272: 11 98 55      ld   de,$5510
1275: D8            ret  c
1276: 20 DA         jr   nz,$12CA
1278: 49            ld   c,c
1279: CF            rst  $08
127A: 48            ld   c,b
127B: D4 06 9B      call nc,$1306
127E: 18 D8         jr   $12D0
1280: 45            ld   b,l
1281: C6 47         add  a,$47
1283: C7            rst  $00
...
1286: 04            inc  b
1287: 9D            sbc  a,l
1288: 10 DA         djnz $12DC
128A: 41            ld   b,c
128B: CB 63         bit  4,e
128D: 08            ex   af,af'
128E: 54            ld   d,h
128F: CD 53 DC      call $5453
1292: 20 4F         jr   nz,$12E3
1294: CE 0E         adc  a,$0E
1296: 15            dec  d
1297: 98            sbc  a,b
1298: 4F            ld   c,a
...
12A9: 08            ex   af,af'
12AA: 50            ld   d,b
12AB: DC 53 32      call c,$BA53
12AE: 22 85 10      ld   ($100D),hl
12B1: BB            cp   e
12B2: 30 B8         jr   nc,$12E4
12B4: 30 B0         jr   nc,$1266
12B6: 04            inc  b
12B7: 19            add  hl,de
12B8: 10 CB         djnz $12FD
12BA: 4F            ld   c,a
12BB: 49            ld   c,c
12BC: 4E            ld   c,(hl)
12BD: B9            cp   c
12BE: 20 A8         jr   nz,$12E0
12C0: 08            ex   af,af'
12C1: CB 67         bit  4,a
12C3: C1            pop  bc
12C4: 66            ld   h,(hl)
...
12C7: 08            ex   af,af'
12C8: 43            ld   b,e
12C9: DA 45 CC      jp   c,$4445
12CC: 61            ld   h,c
12CD: FC 04 93      call m,$1B04
12D0: 10 CB         djnz $1315
12D2: 4F            ld   c,a
12D3: 49            ld   c,c
12D4: 4E            ld   c,(hl)
12D5: BA            cp   d
12D6: 20 A8         jr   nz,$12F8
12D8: 20 CB         jr   nz,$131D
12DA: 4F            ld   c,a
12DB: 49            ld   c,c
12DC: 4E            ld   c,(hl)
12DD: A8            xor  b
12DE: 20 A8         jr   nz,$1300
12E0: 43            ld   b,e
12E1: DA 45 CC      jp   c,$4445
12E4: 61            ld   h,c
12E5: FC 27 9F      call m,$170F
12E8: 30 CD         jr   nc,$132F
12EA: 41            ld   b,c
12EB: DB F1         in   a,($D9)
12ED: 87            add  a,a
12EE: 17            rla
...
12F8: 18 48         jr   $1342
12FA: 41            ld   b,c
12FB: DA C4 0F      jp   c,$0FC4
12FE: 17            rla
12FF: 18 C8         jr   $1349
1301: 69            ld   l,c
1302: D2 6C C5      jp   nc,$4544
1305: 7B            ld   a,e
1306: 54            ld   d,h
1307: 2C            inc  l
1308: 97            sub  a
1309: 30 C4         jr   nc,$134F
130B: 61            ld   h,c
130C: C6 6E         add  a,$46
130E: C9            ret
130F: 6B            ld   l,e
1310: 55            ld   d,l
1311: E4 54 71      call po,$D954
1314: CD 4D 28      call $28E5
1317: 21 64 93      ld   hl,$1364
131A: CD 5C 29      call print_line_29F4
131D: AF            xor  a
131E: 32 C8 08      ld   ($8860),a
1321: CD 5F 3B      call $13DF
1324: CD D6 93      call $13FE
1327: CD 9D 3C      call $141D
132A: CD B4 94      call $143C
132D: 21 F2 3B      ld   hl,$1372
1330: 3A C8 88      ld   a,($8860)
1333: A7            and  a
...
1363: C9            ret
1364: 88            adc  a,b
1365: 22 90 6D      ld   ($4510),hl
1368: D0            ret  nc
1369: 7A            ld   a,d
136A: CF            rst  $08
136B: 65            ld   h,l
136C: D3 A8         out  ($20),a
136E: D4 6D 53      call nc,$5345
1371: 54            ld   d,h
1372: 08            ex   af,af'
1373: B0            or   b
1374: 10 C1         djnz $13B7
1376: 4C            ld   c,h
1377: E4 20 D2      call po,$5220
137A: 4F            ld   c,a
137B: E5            push hl
137C: 53            ld   d,e
137D: 88            adc  a,b
...
1389: 65            ld   h,l
138A: 53            ld   d,e
138B: 20 8E         jr   nz,$139B
138D: 38 D2         jr   c,$13E1
138F: 67            ld   h,a
1390: 4D            ld   c,l
1391: 99            sbc  a,c
1392: 20 E7         jr   nz,$13E3
1394: CB A0         res  4,b
1396: 0E 96         ld   c,$16
1398: 52            ld   d,d
1399: E7            rst  $20
139A: 4D            ld   c,l
139B: 99            sbc  a,c
139C: 20 C2         jr   nz,$13E0
139E: 41            ld   b,c
139F: 44            ld   b,h
13A0: 88            adc  a,b
13A1: 38 90         jr   c,$13B3
13A3: 7A            ld   a,d
13A4: CF            rst  $08
13A5: 65            ld   h,l
13A6: B2            or   d
...
13A9: 43            ld   b,e
13AA: 88            adc  a,b
13AB: 38 96         jr   c,$13C3
13AD: 7A            ld   a,d
13AE: CF            rst  $08
13AF: 65            ld   h,l
13B0: 32 88 42      ld   ($4220),a
13B3: C1            pop  bc
13B4: C4 A0 12      call nz,$1208
13B7: 90            sub  b
13B8: 52            ld   d,d
13B9: E7            rst  $20
13BA: 4D            ld   c,l
13BB: 9B            sbc  a,e
13BC: 20 E7         jr   nz,$140D
13BE: CB A0         res  4,b
13C0: 92            sub  d
13C1: 3E D2         ld   a,$52
13C3: 67            ld   h,a
13C4: CD BB A0      call $2033
13C7: 6A            ld   l,d
13C8: C1            pop  bc
13C9: 4C            ld   c,h
13CA: 88            adc  a,b
...
13DC: 42            ld   b,d
13DD: C1            pop  bc
13DE: C4 21 80      call nz,$0089
13E1: 28 01         jr   z,$1364
13E3: 28 A0         jr   z,$1405
13E5: CD DB 3C      call $145B
...
1621: C9            ret
1622: 52            ld   d,d
1623: FC 08 C7      call m,$4F20
1626: E6 C7         and  $4F
1628: 46            ld   b,(hl)
1629: EE 55         xor  $55
162B: D8            ret  c
162C: 3A 12 3A      ld   a,($3A3A)
162F: 12            ld   (de),a
1630: 3A 3A BA      ld   a,($BA3A)
1633: CC 4F DF      call z,$574F
1636: 4E            ld   c,(hl)
1637: 3A 3A 3A      ld   a,($3A3A)
163A: 3A 32 4C      ld   a,($4CBA)
163D: CD 46 DC      call $5446
1640: 3A 12 3A      ld   a,($3A3A)
1643: 12            ld   (de),a
1644: BA            cp   d
1645: DA 61 CF      jp   c,$4749
1648: 60            ld   h,b
1649: DC 3A 12      call c,$3A3A
164C: 3A 32 50      ld   a,($50BA)
164F: DD 53         db   $dd,$53
1651: 48            ld   c,b
1652: 3A 3A 3A      ld   a,($3A3A)
1655: 3A BA D8      ld   a,($50BA)
1658: B1            or   c
1659: D8            ret  c
165A: B2            or   d
165B: D8            ret  c
...
165D: C9            ret
165E: 59            ld   e,c
165F: CD 52 08      call $2052
1662: 43            ld   b,e
1663: C7            rst  $00
1664: 66            ld   h,(hl)
1665: DC 52 C7      call c,$4F52
1668: 64            ld   h,h
1669: FB            ei
166A: 19            add  hl,de
166B: D8            ret  c
...
166E: 08            ex   af,af'
166F: 08            ex   af,af'
1670: 20 A8         jr   nz,$1692
1672: 20 A8         jr   nz,$1694
1674: 32 D0 F3      ld   ($F3D0),a
1677: 3E 04         ld   a,$04
1679: 32 03 04      ld   ($8C03),a
167C: CD B0 16      call $16B0
167F: 3E 3C         ld   a,$3C
...
16FE: CB 6F         bit  5,a
1700: C0            ret  nz
1701: 3A 40 18      ld   a,($90C0)
1704: 06 69         ld   b,$41
1706: 2F            cpl
1707: CB 67         bit  4,a
1709: C0            ret  nz
170A: 04            inc  b
170B: 3A 40 18      ld   a,($90C0)
170E: 2F            cpl
170F: CB 6F         bit  5,a
1711: C0            ret  nz
...
1715: C9            ret
1716: 3E 85         ld   a,$05
1718: 32 82 8C      ld   ($8C02),a
171B: 3E 24         ld   a,$24
171D: 32 01 24      ld   ($8C01),a
1720: CD 72 97      call $175A
1723: CD E7 3F      call $1767
1726: 3A 2A 0C      ld   a,($8C02)
1729: 90            sub  b
172A: 32 2A 0C      ld   ($8C02),a
172D: CD DA 3F      call $175A
1730: CD CF 17      call $1767
1733: 78            ld   a,b
1734: A7            and  a
1735: CA 49 97      jp   z,$1749
1738: 21 81 8C      ld   hl,$8C01
173B: 35            dec  (hl)
173C: 21 82 8C      ld   hl,$8C02
173F: 35            dec  (hl)
1740: CA 61 97      jp   z,$1749
1743: CD DA 3F      call $175A
1746: C3 B8 97      jp   $1730
1749: CD DA 3F      call $175A
174C: 21 29 0C      ld   hl,$8C01
174F: 35            dec  (hl)
1750: C2 E1 17      jp   nz,$1749
1753: 3A 02 24      ld   a,($8C02)
1756: A7            and  a
1757: C8            ret  z
1758: 37            scf
1759: C9            ret
...
1766: C9            ret
1767: 06 80         ld   b,$00
1769: 3A 80 04      ld   a,($8C00)
176C: FE 69         cp   $41
176E: C2 F1 17      jp   nz,$1779
1771: 3A C0 10      ld   a,($90C0)
1774: CB 67         bit  4,a
1776: C0            ret  nz
1777: 04            inc  b
1778: C9            ret
1779: 3A C0 10      ld   a,($90C0)
177C: CB 6F         bit  5,a
177E: C0            ret  nz
177F: 04            inc  b
1780: C9            ret
1781: 3E A4         ld   a,$24
1783: 32 81 04      ld   ($8C01),a
1786: CD 72 97      call $175A
...
17C7: 18 73         jr   $17BC
17C9: CD 65 A0      call $28E5
17CC: CD C7 97      call $17EF
17CF: 21 D9 97      ld   hl,$17D9
...
17DA: 00            nop
17DB: 90            sub  b
17DC: 30 88         jr   nc,$17FE
17DE: 31 88 B2      ld   sp,$3220
17E1: A8            xor  b
17E2: B3            or   e
17E3: A8            xor  b
17E4: A0            and  b
...
181E: 26 88         ld   h,$00
1820: 69            ld   l,c
1821: CD 40 03      call $2B40
1824: 3A 8A A0      ld   a,($8802)
1827: F5            push af
1828: 3E 98         ld   a,$10
182A: 32 8A A0      ld   ($8802),a
182D: CD 6F 04      call $2C6F
1830: F1            pop  af
...
18A4: 36 88         ld   (hl),$00
18A6: AF            xor  a
18A7: 32 58 A4      ld   ($8C70),a
18AA: 32 A8 A4      ld   ($8C80),a
18AD: 18 DB         jr   $18A2
18AF: F3            di
18B0: 21 90 8C      ld   hl,$8C90
18B3: 04            inc  b
...
18BC: 3E 77         ld   a,$FF
18BE: 32 34 A4      ld   ($8CBC),a
18C1: FB            ei
18C2: C9            ret
18C3: 36 00         ld   (hl),$00
18C5: 18 FA         jr   $18C1
18C7: F3            di
18C8: 21 28 A4      ld   hl,$8CA0
18CB: 04            inc  b
...
18E1: 3E FF         ld   a,$FF
18E3: 32 BD A4      ld   ($8CBD),a
18E6: FB            ei
18E7: C9            ret
18E8: 36 88         ld   (hl),$00
18EA: 18 72         jr   $18E6
18EC: 3E 89         ld   a,$01
18EE: 32 C9 90      ld   ($9041),a
18F1: C9            ret
18F2: 3E 88         ld   a,$00
18F4: 32 C9 90      ld   ($9041),a
18F7: C9            ret
18F8: 57            ld   d,a
18F9: E6 70         and  $70
18FB: 5F            ld   e,a
...
191E: 5C            ld   e,h
191F: 80            add  a,b
1920: E2 28 E7      jp   po,$6700
1923: 28 EE         jr   z,$1993
1925: 28 F4         jr   z,$199B
1927: 28 FB         jr   z,$19A4
1929: 28 02         jr   z,$18AD
192B: 28 0A         jr   z,$18B7
192D: 28 12         jr   z,$18C1
192F: 28 9B         jr   z,$18CC
1931: 80            add  a,b
1932: A4            and  h
1933: 80            add  a,b
1934: AE            xor  (hl)
...
1936: B9            cp   c
1937: 80            add  a,b
1938: C4 80 CF      call nz,$CF00
193B: 80            add  a,b
193C: DC 80 E9      call c,$E900
193F: 80            add  a,b
1940: 76            halt
1941: 28 85         jr   z,$1948
1943: 29            add  hl,hl
1944: 95            sub  l
1945: 29            add  hl,hl
1946: A5            and  l
...
194A: C9            ret
194B: 29            add  hl,hl
194C: DD 29         add  ix,ix
194E: F2 29 88      jp   p,$8801
1951: 81            add  a,c
1952: 9F            sbc  a,a
1953: 81            add  a,c
1954: B8            cp   b
1955: 81            add  a,c
1956: D2 81 ED      jp   nc,$ED01
1959: 81            add  a,c
195A: 0B            dec  bc
195B: 82            add  a,d
195C: 2A 82 4B      ld   hl,($4B02)
195F: 82            add  a,d
1960: EE 2A         xor  $02
1962: 13            inc  de
1963: 2A 3A 2A      ld   hl,($02BA)
1966: 63            ld   h,e
1967: 2A 8F 2B      ld   hl,($030F)
196A: BE            cp   (hl)
196B: 2B            dec  hl
196C: F0            ret  p
196D: 2B            dec  hl
...
1976: 96            sub  (hl)
1977: 84            add  a,h
1978: DC 84 26      call c,$2604
197B: 85            add  a,l
197C: 74            ld   (hl),h
197D: 85            add  a,l
197E: C2 85 9F      jp   nz,$1F05
1981: 2E FD         ld   l,$7D
1983: 2E 60         ld   l,$E0
1985: 2E C8         ld   l,$48
1987: 2F            cpl
...
1989: 2F            cpl
198A: AD            xor  l
198B: 20 29         jr   nz,$1936
198D: 20 AD         jr   nz,$19BC
198F: 21 B9 A1      ld   hl,$09B9
1992: 4D            ld   c,l
1993: A2            and  d
1994: E9            jp   (hl)
1995: A2            and  d
...
1998: 3F            ccf
1999: A4            and  h
199A: FA A4 C0      jp   m,$C00C
199D: A5            and  l
199E: 91            sub  c
199F: A6            and  (hl)
19A0: EF            rst  $28
19A1: 27            daa
19A2: DA 38 D2      jp   c,$5210
19A5: 39            add  hl,sp
19A6: DA 3A F2      jp   c,$7212
19A9: 3B            dec  sp
19AA: 1A            ld   a,(de)
19AB: 3C            inc  a
19AC: 53            ld   d,e
...
19B0: 7F            ld   a,a
19B1: B0            or   b
19B2: F4 B1 80      call p,$8019
19B5: B3            or   e
19B6: 22 B5 DE      ld   ($DE1D),hl
19B9: B6            or   (hl)
19BA: B4            or   h
19BB: 88            adc  a,b
19BC: A5            and  l
...
19C3: A1            and  c
19C4: 81            add  a,c
19C5: 28 81         jr   z,$19C8
19C7: 28 81         jr   z,$19CA
19C9: 28 81         jr   z,$19CC
19CB: 28 81         jr   z,$19CE
19CD: 28 81         jr   z,$19D0
19CF: 28 01         jr   z,$19D2
19D1: 80            add  a,b
19D2: D5            push de
19D3: 3A BE 24      ld   a,($8CBE)
19D6: 11 74 19      ld   de,$19DC
19D9: C3 8F AD      jp   indirect_jump_2D8F
19DC: E6 B1         and  $19
19DE: FC B1 81      call m,$0119
19E1: 32 86 32      ld   ($1A06),a
19E4: 8B            adc  a,e
19E5: 32 21 29      ld   ($01A1),a
19E8: 0F            rrca
19E9: D1            pop  de
19EA: 7B            ld   a,e
19EB: 77            ld   (hl),a
...
19FA: 77            ld   (hl),a
19FB: C9            ret
19FC: 21 88 8F      ld   hl,$8F20
19FF: 18 E8         jr   $19E9
1A01: 21 18 A7      ld   hl,$8F30
1A04: 18 6B         jr   $19E9
1A06: 21 00 A7      ld   hl,$8F28
1A09: 18 F6         jr   $19E9
1A0B: 21 38 A7      ld   hl,$8F38
1A0E: 18 F1         jr   $19E9
1A10: CB E7         set  4,a
1A12: 18 8A         jr   $1A16
1A14: CB EF         set  5,a
1A16: F5            push af
1A17: 3A BE 04      ld   a,($8CBE)
1A1A: 11 A8 1A      ld   de,$1A20
1A1D: C3 8F 2D      jp   indirect_jump_2D8F
1A20: 2A 92 53      ld   hl,($531A)
1A23: 92            sub  d
1A24: 70            ld   (hl),b
1A25: 92            sub  d
1A26: 75            ld   (hl),l
...
1A51: 77            ld   (hl),a
1A52: C9            ret
1A53: 21 24 07      ld   hl,$8F24
1A56: 18 D5         jr   $1A2D
1A58: 21 BC 8F      ld   hl,$8F34
1A5B: 18 D0         jr   $1A2D
1A5D: 21 2C 07      ld   hl,$8F2C
1A60: 18 E3         jr   $1A2D
1A62: 21 14 A7      ld   hl,$8F3C
1A65: 18 C6         jr   $1A2D
1A67: F5            push af
...
1B26: D1            pop  de
1B27: 21 3F 04      ld   hl,$8CBF
1B2A: CB C6         set  0,(hl)
1B2C: C9            ret
1B2D: D7            rst  $10
1B2E: 7E            ld   a,(hl)
1B2F: D5            push de
1B30: FC 7B FA      call m,$FAFB
1B33: 79            ld   a,c
1B34: F7            rst  $30
1B35: 5E            ld   e,(hl)
1B36: F5            push af
...
1B68: 21 97 0C      ld   hl,$8CBF
1B6B: CB C6         set  0,(hl)
1B6D: 3A 3E 04      ld   a,($8CBE)
1B70: FE 83         cp   $03
...
1B79: E1            pop  hl
1B7A: C9            ret
1B7B: 3A 11 27      ld   a,($8F11)
1B7E: F6 58         or   $F0
1B80: 32 39 0F      ld   ($8F11),a
1B83: 21 3C 04      ld   hl,$8CBC
1B86: 36 28         ld   (hl),$00
1B88: E1            pop  hl
1B89: E1            pop  hl
1B8A: C9            ret
1B8B: 3A 92 07      ld   a,($8F12)
1B8E: F6 D8         or   $F0
1B90: 32 92 8F      ld   ($8F12),a
1B93: 21 BD 24      ld   hl,$8CBD
1B96: 18 6E         jr   $1B86
1B98: E1            pop  hl
1B99: 23            inc  hl
1B9A: 7E            ld   a,(hl)
...
1C9E: 21 B3 34      ld   hl,$1CB3
1CA1: 01 20 88      ld   bc,$0008
1CA4: ED B1         cpir
1CA6: CB 21         sla  c
1CA8: CB 10         rl   b
1CAA: 21 33 34      ld   hl,$1CBB
1CAD: 09            add  hl,bc
1CAE: 5E            ld   e,(hl)
1CAF: 23            inc  hl
1CB0: 56            ld   d,(hl)
...
1CC5: F8            ret  m
1CC6: 34            inc  (hl)
1CC7: FA 34 F2      jp   m,$DA1C
1CCA: 34            inc  (hl)
1CCB: CD C8 94      call $1CE0
1CCE: 18 98         jr   $1CE0
1CD0: 18 0E         jr   $1CE0
...
1CE5: 21 BF A4      ld   hl,$8CBF
1CE8: CB C6         set  0,(hl)
1CEA: C9            ret
1CEB: DD 7E 81      ld   a,(ix+$09)
1CEE: 21 68 1C      ld   hl,$1CE0
1CF1: E5            push hl
1CF2: FE 8D         cp   $05
1CF4: C8            ret  z
1CF5: FE 0A         cp   $0A
...
1D3D: CD A2 B5      call $1DA2	; snobee1
1D40: CD 80 9D      call $1DA8	; 2
1D43: CD 2E 35      call $1DAE	; 3
1D46: CD 9C 9D      call $1DB4	; 4
1D49: CD 3A 35      call $1DBA	; pengo
1D4C: CD 48 9D      call $1DC0	; moving block
...
init_all_characters_states_1D60:
	DD 21 80 05   ld   ix,snobee_1_struct_8D00
1D64: 11 A8 80      ld   de,$0020
1D67: DD 36 37 80   ld   (ix+$1f),$00
1D6B: DD 36 2D 81   ld   (ix+$05),$01
1D6F: DD 19         add  ix,de
1D71: DD 36 B7 00   ld   (ix+$1f),$00
1D75: DD 36 85 02   ld   (ix+$05),$02
1D79: DD 19         add  ix,de
1D7B: DD 36 B7 00   ld   (ix+$1f),$00
1D7F: DD 36 2D 83   ld   (ix+$05),$03
1D83: DD 19         add  ix,de
1D85: DD 36 37 80   ld   (ix+$1f),$00
1D89: DD 36 2D 84   ld   (ix+$05),$04
1D8D: DD 19         add  ix,de
1D8F: DD 36 B7 00   ld   (ix+$1f),$00
1D93: DD 36 85 05   ld   (ix+$05),$05
1D97: DD 19         add  ix,de
1D99: DD 36 B7 00   ld   (ix+$1f),$00
1D9D: DD 36 85 86   ld   (ix+$05),$06
1DA1: C9            ret
...
1DEF: C8            ret  z
1DF0: 1D            dec  e
1DF1: D2 1F 48      jp   nc,$E01F
1DF4: 1D            dec  e
1DF5: 74            ld   (hl),h
1DF6: 20 48         jr   nz,$1DD8
1DF8: 1D            dec  e
1DF9: 34            inc  (hl)
1DFA: 1E 48         ld   e,$E0
1DFC: 1D            dec  e
1DFD: 10 1F         djnz $1E1E
1DFF: E6 08         and  $20
1E01: 68            ld   l,b
1E02: 35            dec  (hl)
1E03: 68            ld   l,b
...
1E05: DD 36 88 00   ld   (ix+$00),$00
1E09: DD 36 89 B0   ld   (ix+$01),$98
1E0D: DD 36 8A 08   ld   (ix+$02),$08
1E11: DD 7E 8D      ld   a,(ix+$05)
1E14: 3C            inc  a
1E15: 3C            inc  a
1E16: DD 77 03      ld   (ix+$03),a
1E19: CD 26 1E      call $1E26
1E1C: DD 7E 05      ld   a,(ix+$05)
1E1F: FE 01         cp   $01
1E21: C0            ret  nz
1E22: DD 34 37      inc  (ix+$1f)
1E25: C9            ret
1E26: DD 36 04 8B   ld   (ix+$04),$03
1E2A: DD 36 06 82   ld   (ix+$06),$0A
1E2E: DD 36 07 88   ld   (ix+$07),$00
...
1E4A: CD 23 39      call $39AB
1E4D: CD E6 1B      call $33CE
1E50: DD 34 1F      inc  (ix+$1f)
1E53: C9            ret
1E54: 21 84 1E      ld   hl,$1E84
1E57: CD 64 1E      call $1E64
1E5A: DD 7E 05      ld   a,(ix+$05)
1E5D: FE 01         cp   $01
1E5F: C0            ret  nz
1E60: DD 34 37      inc  (ix+$1f)
1E63: C9            ret
1E64: DD 7E 05      ld   a,(ix+$05)
1E67: 3D            dec  a
1E68: 07            rlca
1E69: 07            rlca
1E6A: 16 88         ld   d,$00
...
1E6E: 7E            ld   a,(hl)
1E6F: 23            inc  hl
1E70: DD 77 00      ld   (ix+$00),a
1E73: 7E            ld   a,(hl)
1E74: 23            inc  hl
1E75: DD 77 89      ld   (ix+$01),a
1E78: 7E            ld   a,(hl)
1E79: 23            inc  hl
1E7A: DD 77 02      ld   (ix+$02),a
1E7D: 7E            ld   a,(hl)
1E7E: 23            inc  hl
1E7F: DD 77 8B      ld   (ix+$03),a
1E82: 18 2A         jr   $1E26
1E84: 00            nop
1E85: B0            or   b
1E86: 20 81         jr   nz,$1E91
1E88: 58            ld   e,b
1E89: A0            and  b
1E8A: 58            ld   e,b
1E8B: 98            sbc  a,b
...
1E8F: 98            sbc  a,b
1E90: 70            ld   (hl),b
1E91: 10 70         djnz $1F03
1E93: 98            sbc  a,b
1E94: 80            add  a,b
1E95: 10 70         djnz $1F07
1E97: 98            sbc  a,b
1E98: 70            ld   (hl),b
1E99: 90            sub  b
1E9A: F0            ret  p
1E9B: 0B            dec  bc
1E9C: 21 24 1E      ld   hl,$1EAC
1E9F: CD 4C 96      call $1E64
1EA2: DD 7E 05      ld   a,(ix+$05)
1EA5: FE 04         cp   $04
1EA7: D0            ret  nc
1EA8: DD 34 37      inc  (ix+$1f)
1EAB: C9            ret
1EAC: 00            nop
1EAD: 00            nop
1EAE: 20 82         jr   nz,$1EBA
1EB0: 00            nop
1EB1: D8            ret  c
1EB2: 08            ex   af,af'
1EB3: 0B            dec  bc
...
1EBF: 0D            dec  c
1EC0: 00            nop
1EC1: 10 20         djnz $1ECB
1EC3: 84            add  a,h
1EC4: CD 78 36      call $1EF0
1EC7: DD 34 8F      inc  (ix+$07)
1ECA: DD 7E 07      ld   a,(ix+$07)
1ECD: DD BE 8E      cp   (ix+$06)
1ED0: D8            ret  c
1ED1: DD 36 8F 00   ld   (ix+$07),$00
1ED5: 3E 18         ld   a,$18
1ED7: DD BE 88      cp   (ix+$00)
1EDA: CC 9F 1F      call z,$1F17
1EDD: 3E B0         ld   a,$B0
1EDF: DD BE 88      cp   (ix+$00)
1EE2: CC 0C 37      call z,$1F24
1EE5: 3E D8         ld   a,$F0
1EE7: DD BE 88      cp   (ix+$00)
1EEA: CC C6 37      call z,$1F4E
1EED: C3 D7 15      jp   $3DD7
1EF0: 3A AC 88      ld   a,(counter_8824)
1EF3: E6 1F         and  $1F
1EF5: C0            ret  nz
	;; counter 1 out of 32 xxx
1EF6: 06 88         ld   b,$00
1EF8: DD 7E 1F      ld   a,(ix+$1f)
1EFB: FE 04         cp   $04
1EFD: 20 09         jr   nz,$1F08
1EFF: DD 7E 36      ld   a,(ix+$1e)
1F02: FE 2B         cp   $03
...
1F1E: DD 34 9F      inc  (ix+$1f)
1F21: DD E1         pop  ix
1F23: C9            ret
1F24: DD 7E 85      ld   a,(ix+$05)
1F27: FE 81         cp   $01
1F29: C0            ret  nz
1F2A: DD E5         push ix
1F2C: DD 34 9F      inc  (ix+$1f)
1F2F: 11 20 80      ld   de,$0020
1F32: DD 19         add  ix,de
1F34: DD 34 1F      inc  (ix+$1f)
1F37: DD 19         add  ix,de
1F39: DD 34 B7      inc  (ix+$1f)
1F3C: DD 19         add  ix,de
1F3E: DD 34 9F      inc  (ix+$1f)
1F41: DD 19         add  ix,de
1F43: DD 34 37      inc  (ix+$1f)
1F46: DD 19         add  ix,de
1F48: DD 34 9F      inc  (ix+$1f)
1F4B: DD E1         pop  ix
1F4D: C9            ret
1F4E: DD 34 1F      inc  (ix+$1f)
1F51: C9            ret
1F52: DD 7E 05      ld   a,(ix+$05)
1F55: FE 01         cp   $01
1F57: CC F0 B6      call z,$1EF0
1F5A: DD 34 07      inc  (ix+$07)
1F5D: DD 7E 87      ld   a,(ix+$07)
1F60: DD BE 86      cp   (ix+$06)
1F63: D8            ret  c
1F64: DD 36 87 28   ld   (ix+$07),$00
1F68: 3E E8         ld   a,$60
1F6A: DD BE 80      cp   (ix+$00)
1F6D: CC FB 37      call z,$1F7B
1F70: 3E 58         ld   a,$F0
1F72: DD BE 00      cp   (ix+$00)
1F75: CC 4E B7      call z,$1F4E
1F78: C3 57 3D      jp   $3DD7
1F7B: CD 24 B7      call $1F24
1F7E: DD E5         push ix
1F80: DD 21 20 05   ld   ix,$moving_block_struct_8DA0
1F84: DD 34 9F      inc  (ix+$1f)
1F87: DD 34 37      inc  (ix+$1f)
1F8A: DD E1         pop  ix
1F8C: DD 35 9F      dec  (ix+$1f)
1F8F: C9            ret
1F90: CD 4C 1F      call $1FE4
1F93: DD 34 87      inc  (ix+$07)
1F96: DD 7E 07      ld   a,(ix+$07)
1F99: DD BE 86      cp   (ix+$06)
1F9C: D8            ret  c
1F9D: DD 36 87 80   ld   (ix+$07),$00
1FA1: CD 45 37      call $1FC5
1FA4: 3E D7         ld   a,$FF
1FA6: DD BE 80      cp   (ix+$00)
1FA9: CC 8A A8      call z,$200A
1FAC: 3E 60         ld   a,$48
1FAE: DD BE 00      cp   (ix+$00)
1FB1: CC 32 88      call z,$2032
1FB4: 21 5F 1F      ld   hl,$1FF7
1FB7: DD 7E 80      ld   a,(ix+$00)
1FBA: 01 93 00      ld   bc,$0013
1FBD: ED B1         cpir
1FBF: CC BD A8      call z,$203D
1FC2: C3 5F BD      jp   $3DD7
1FC5: DD 7E 2D      ld   a,(ix+$05)
1FC8: FE 29         cp   $01
1FCA: C0            ret  nz
1FCB: DD 7E 28      ld   a,(ix+$00)
1FCE: E6 2F         and  $07
1FD0: C0            ret  nz
1FD1: 06 16         ld   b,$16
1FD3: 0E 07         ld   c,$07
...
1FEC: 3A AC 08      ld   a,(counter_8824)
1FEF: E6 1F         and  $1F
1FF1: C0            ret  nz
	;; counter 1 out of 32 xxx
1FF2: 06 92         ld   b,$12
...
2004: 00            nop
2005: 08            ex   af,af'
2006: 10 18         djnz $1FC0
2008: 48            ld   c,b
2009: C8            ret  z
200A: DD E5         push ix
200C: DD 34 BF      inc  (ix+$1f)
200F: DD 21 40 8D   ld   ix,snobee_4_struct_8D60
2013: 11 20 20      ld   de,$0020
2016: DD 34 1F      inc  (ix+$1f)
2019: DD 34 B7      inc  (ix+$1f)
201C: DD 19         add  ix,de
201E: DD 34 BF      inc  (ix+$1f)
2021: DD 34 97      inc  (ix+$1f)
2024: DD 19         add  ix,de
2026: DD 34 BF      inc  (ix+$1f)
2029: DD 34 97      inc  (ix+$1f)
202C: DD E1         pop  ix
202E: CD B5 06      call $0615
2031: C9            ret
2032: DD 7E 05      ld   a,(ix+$05)
2035: FE 01         cp   $01
2037: C8            ret  z
2038: FE 24         cp   $04
203A: D0            ret  nc
...
2051: DD 34 27      inc  (ix+$07)
2054: DD 7E 07      ld   a,(ix+$07)
2057: DD BE 26      cp   (ix+$06)
205A: D8            ret  c
205B: DD 36 27 00   ld   (ix+$07),$00
205F: CD 4D 97      call $1FC5
2062: DD 7E 28      ld   a,(ix+$00)
2065: E6 2F         and  $07
2067: CC 04 20      call z,$20A4
206A: DD 7E 28      ld   a,(ix+$00)
206D: FE E1         cp   $69
206F: CC 85 00      call z,$2085
2072: DD 7E 00      ld   a,(ix+$00)
2075: FE 28         cp   $28
2077: CC 93 00      call z,$2093
207A: DD 7E 00      ld   a,(ix+$00)
207D: FE F8         cp   $F8
...
2088: A7            and  a
2089: C0            ret  nz
208A: DD 36 2C A2   ld   (ix+$04),$02
208E: DD 36 09 DF   ld   (ix+$09),$FF
2092: C9            ret
2093: DD 36 24 03   ld   (ix+$04),$03
2097: C9            ret
2098: DD 34 1F      inc  (ix+$1f)
209B: DD 7E 25      ld   a,(ix+$05)
209E: FE 26         cp   $06
20A0: DD 34 BF      inc  (ix+$1f)
20A3: C9            ret
20A4: DD 7E 28      ld   a,(ix+$00)
20A7: 0F            rrca
20A8: 0F            rrca
20A9: 0F            rrca
20AA: E6 97         and  $1F
...
20C4: 06 80         ld   b,$08
20C6: C5            push bc
20C7: CD A5 01      call $292D
20CA: CD 91 A1      call $2919
20CD: C1            pop  bc
20CE: 10 7E         djnz $20C6
20D0: C9            ret
20D1: 26 00         ld   h,$00
20D3: DD 6E B6      ld   l,(ix+$1e)
20D6: 29            add  hl,hl
20D7: 19            add  hl,de
20D8: 5E            ld   e,(hl)
20D9: 23            inc  hl
20DA: 56            ld   d,(hl)
20DB: C9            ret
20DC: 11 C8 20      ld   de,$20E8
20DF: CD 59 20      call $20D1
20E2: DD 7E AB      ld   a,(ix+$0b)
20E5: C3 8F 05      jp   indirect_jump_2D8F
20E8: D0            ret  nc
20E9: 20 EC         jr   nz,$2137
20EB: 21 08 21      ld   hl,$2180
20EE: 90            sub  b
20EF: 21 CC 01      ld   hl,$21CC
20F2: 65            ld   h,l
20F3: 02            ld   (bc),a
20F4: CC 01 65      call z,$6521
20F7: 02            ld   (bc),a
20F8: 30 01         jr   nc,$211B
20FA: FA 97 6E      jp   m,$6E3F
20FD: 60            ld   h,b
20FE: 1F            rra
20FF: 60            ld   h,b
2100: 4E            ld   c,(hl)
...
212E: C8            ret  z
212F: 89            adc  a,c
2130: DD 36 04 A1   ld   (ix+$04),$01
2134: DD 34 0B      inc  (ix+$0b)
2137: C9            ret
2138: DD 36 04 A2   ld   (ix+$04),$02
213C: DD 34 0B      inc  (ix+$0b)
213F: C9            ret
2140: DD 36 AC 83   ld   (ix+$04),$03
2144: DD 34 8B      inc  (ix+$0b)
2147: C9            ret
2148: DD 34 9F      inc  (ix+$1f)
214B: C9            ret
214C: E8            ret  pe
214D: 89            adc  a,c
214E: 52            ld   d,d
...
216F: 89            adc  a,c
2170: 06 50         ld   b,$78
2172: DD 70 02      ld   (ix+$02),b
2175: CD AB 11      call $39AB
...
2198: C9            ret
2199: DD 36 82 0A   ld   (ix+$0a),$0A
219D: DD 36 81 8F   ld   (ix+$09),$0F
21A1: C9            ret
21A2: DD 36 AA 14   ld   (ix+$02),$94
21A6: CD 2B 19      call $39AB
21A9: DD 34 A3      inc  (ix+$0b)
21AC: C9            ret
21AD: DD 36 82 12   ld   (ix+$02),$12
21B1: CD AB 11      call $39AB
21B4: DD 34 0B      inc  (ix+$0b)
21B7: C9            ret
21B8: 8E            adc  a,(hl)
21B9: 21 30 21      ld   hl,$2130
21BC: 8E            adc  a,(hl)
21BD: 21 40 21      ld   hl,$2140
21C0: E4 89 C8      call po,$4821
21C3: 89            adc  a,c
...
21CF: 89            adc  a,c
21D0: 0C            inc  c
21D1: 22 6E E0      ld   ($406E),hl
21D4: 1B            dec  de
21D5: 22 6E E0      ld   ($406E),hl
21D8: 0C            inc  c
21D9: 22 6E E0      ld   ($406E),hl
21DC: 1B            dec  de
21DD: 22 8E 21      ld   ($218E),hl
21E0: 8C            adc  a,h
21E1: 8A            adc  a,d
21E2: 4E            ld   c,(hl)
21E3: C0            ret  nz
...
21EF: 89            adc  a,c
21F0: 8E            adc  a,(hl)
21F1: 21 2A 22      ld   hl,$222A
21F4: 8E            adc  a,(hl)
21F5: 21 35 22      ld   hl,$2235
21F8: 0C            inc  c
21F9: 22 6E E0      ld   ($406E),hl
21FC: 1B            dec  de
21FD: 22 6E E0      ld   ($406E),hl
2200: AC            xor  h
2201: 22 E6 E0      ld   ($406E),hl
2204: BB            cp   e
2205: 22 8E 21      ld   ($218E),hl
2208: 1F            rra
2209: 22 E8 21      ld   ($2148),hl
220C: DD 36 28 72   ld   (ix+$00),$72
2210: DD 36 01 3A   ld   (ix+$01),$92
2214: CD EE 33      call $33CE
2217: DD 34 A3      inc  (ix+$0b)
221A: C9            ret
221B: DD 36 20 70   ld   (ix+$00),$70
221F: DD 36 A1 18   ld   (ix+$01),$90
2223: CD CE 33      call $33CE
2226: DD 34 AB      inc  (ix+$0b)
2229: C9            ret
222A: DD 36 2A 7C   ld   (ix+$02),$F4
222E: CD 0B 39      call $39AB
2231: DD 34 A3      inc  (ix+$0b)
2234: C9            ret
2235: DD 36 22 F0   ld   (ix+$02),$F0
2239: CD AB 91      call $39AB
...
2264: C9            ret
2265: E0            ret  po
2266: 22 BF 22      ld   ($2297),hl
2269: 8E            adc  a,(hl)
226A: 21 8E 21      ld   hl,$218E
226D: 8E            adc  a,(hl)
226E: 21 2E 22      ld   hl,$22A6
2271: 1D            dec  e
2272: 22 C6 40      ld   ($406E),hl
2275: 68            ld   l,b
2276: 22 C6 40      ld   ($406E),hl
2279: 1D            dec  e
227A: 22 C6 40      ld   ($406E),hl
227D: 3F            ccf
227E: 22 AE 21      ld   ($218E),hl
2281: 8E            adc  a,(hl)
2282: 21 2E 22      ld   hl,$22A6
2285: 3D            dec  a
2286: 22 46 68      ld   ($406E),hl
2289: E8            ret  pe
228A: 22 8E 21      ld   ($218E),hl
228D: 8E            adc  a,(hl)
228E: 21 3D 22      ld   hl,$22B5
2291: C6 40         add  a,$40
2293: 3F            ccf
2294: 22 E0 21      ld   ($2148),hl
2297: DD 36 20 00   ld   (ix+$00),$00
229B: DD 36 21 00   ld   (ix+$01),$00
229F: CD CE 33      call $33CE
22A2: DD 34 AB      inc  (ix+$0b)
22A5: C9            ret
22A6: DD 36 28 56   ld   (ix+$00),$7E
22AA: DD 36 29 88   ld   (ix+$01),$88
22AE: CD CE 33      call $33CE
22B1: DD 34 A3      inc  (ix+$0b)
22B4: C9            ret
22B5: DD 36 22 E8   ld   (ix+$02),$E8
22B9: CD AB 91      call $39AB
22BC: DD 34 0B      inc  (ix+$0b)
22BF: C9            ret
22C0: DD 36 2A 4C   ld   (ix+$02),$EC
22C4: CD 0B B1      call $39AB
22C7: DD 34 83      inc  (ix+$0b)
22CA: C9            ret
22CB: CD B9 23      call $2319
22CE: CD 25 23      call $2325
...
22DD: 3A 24 A8      ld   a,(counter_8824)
22E0: A7            and  a
22E1: 20 2E         jr   nz,$22E9
22E3: 3A 25 88      ld   a,($8825)
22E6: CD 5C 24      call $24FC
22E9: CD B6 23      call $233E
22EC: CD E4 23      call $2344
22EF: CD 4A 03      call $234A
22F2: CD 70 23      call $2350
22F5: CD 56 03      call $2356
22F8: CD F4 23      call $235C
22FB: DD 7E B7      ld   a,(ix+$1f)
22FE: FE 22         cp   $02
...
230D: C9            ret
230E: AF            xor  a
230F: 32 47 B8      ld   ($9047),a
2312: 32 E2 90      ld   ($9042),a
2315: 32 46 B8      ld   ($9046),a
2318: C9            ret
2319: 3E 01         ld   a,$01
231B: 32 47 B8      ld   ($9047),a
231E: 32 E2 B0      ld   ($9042),a
2321: 32 EE 10      ld   ($9046),a
2324: C9            ret
...
2360: DD 7E 9F      ld   a,(ix+$1f)
2363: 11 49 8B      ld   de,$2369
...
2372: C9            ret
2373: 21 B7 23      ld   hl,$23B7
2376: DD 7E 05      ld   a,(ix+$05)
2379: 3D            dec  a
237A: 87            add  a,a
237B: 87            add  a,a
237C: 87            add  a,a
...
2380: 19            add  hl,de
2381: 7E            ld   a,(hl)
2382: DD 77 A8      ld   (ix+$00),a
2385: 23            inc  hl
2386: 7E            ld   a,(hl)
2387: DD 77 81      ld   (ix+$01),a
238A: 23            inc  hl
238B: 7E            ld   a,(hl)
238C: 87            add  a,a
238D: 87            add  a,a
238E: DD 77 02      ld   (ix+$02),a
2391: 23            inc  hl
2392: 7E            ld   a,(hl)
2393: DD 77 A3      ld   (ix+$03),a
2396: 23            inc  hl
2397: 7E            ld   a,(hl)
2398: DD 77 04      ld   (ix+$04),a
239B: 23            inc  hl
239C: 7E            ld   a,(hl)
239D: DD 77 A6      ld   (ix+$06),a
23A0: 23            inc  hl
23A1: DD 36 87 A8   ld   (ix+$07),$00
23A5: 7E            ld   a,(hl)
...
23EA: DD 34 AF      inc  (ix+$07)
23ED: DD 7E 87      ld   a,(ix+$07)
23F0: DD BE 06      cp   (ix+$06)
23F3: D8            ret  c
23F4: DD 36 07 A0   ld   (ix+$07),$00
23F8: CD 35 24      call $2435
23FB: CD A0 24      call $24A0
23FE: C9            ret
23FF: 3A 24 88      ld   a,(counter_8824)
2402: E6 A7         and  $07
2404: C0            ret  nz
	;; counter 1 out of 8 xxx
2405: DD 34 84      inc  (ix+$0c)
2408: DD 7E 2A      ld   a,(ix+$02)
240B: E6 D0         and  $F8
240D: DD CB 84 56   bit  2,(ix+$0c)
2411: 20 02         jr   nz,$2415
2413: CB D7         set  2,a
2415: DD 77 22      ld   (ix+$02),a
2418: DD 7E 04      ld   a,(ix+$04)
241B: FE 03         cp   $03
241D: 20 04         jr   nz,$2423
241F: DD CB A2 CE   set  1,(ix+$02)
2423: DD CB B2 6E   bit  0,(ix+$12)
2427: 28 2C         jr   z,$242D
2429: DD CB A2 CE   set  1,(ix+$02)
242D: CD 83 11      call $39AB
2430: C9            ret
...
2494: 7E            ld   a,(hl)
2495: E6 0F         and  $0F
2497: DD 77 26      ld   (ix+$06),a
249A: DD 36 07 20   ld   (ix+$07),$00
249E: C9            ret
249F: C9            ret
24A0: 21 1D 24      ld   hl,$24BD
24A3: E5            push hl
24A4: DD 7E 2C      ld   a,(ix+$04)
24A7: 11 85 24      ld   de,$24AD
24AA: C3 8F A5      jp   indirect_jump_2D8F
24AD: E8            ret  pe
24AE: 24            inc  h
24AF: EC 24 E8      call pe,$C824
24B2: 24            inc  h
24B3: EC 24 78      call pe,$D024
24B6: 24            inc  h
24B7: 7F            ld   a,a
24B8: 24            inc  h
24B9: FE 24         cp   $24
24BB: 4D            ld   c,l
24BC: 24            inc  h
24BD: C3 CE 13      jp   $33CE
24C0: DD 35 29      dec  (ix+$01)
24C3: C9            ret
24C4: DD 34 29      inc  (ix+$01)
24C7: C9            ret
24C8: DD 35 28      dec  (ix+$00)
24CB: C9            ret
24CC: DD 34 28      inc  (ix+$00)
24CF: C9            ret
24D0: CD 68 24      call $24C0
24D3: CD CC 04      call $24CC
24D6: C9            ret
24D7: CD C0 04      call $24C0
24DA: CD E8 24      call $24C8
24DD: C9            ret
24DE: CD 6C 24      call $24C4
24E1: CD CC 24      call $24CC
24E4: C9            ret
24E5: CD 4C 24      call $24C4
24E8: CD C8 24      call $24C8
24EB: C9            ret
24EC: 06 84         ld   b,$0C
24EE: C5            push bc
24EF: 78            ld   a,b
...
251D: C6 4F         add  a,$4F
251F: 05            dec  b
2520: EA C5 ED      jp   pe,$4545
2523: 88            adc  a,b
2524: EC E1 FB      call pe,$5349
2527: D0            ret  nc
2528: CC C1 D9      call z,$5941
252B: 88            adc  a,b
252C: 28 C2         jr   z,$2570
252E: D9            exx
252F: 88            adc  a,b
2530: 4E            ld   c,(hl)
2531: E1            pop  hl
...
253E: FF            rst  $38
253F: 5F            ld   e,a
2540: 21 50 AF      ld   hl,$07D0
2543: 22 D8 20      ld   ($8858),hl
2546: 22 D2 80      ld   ($8852),hl
2549: 22 CC 20      ld   ($884C),hl
254C: 22 C6 80      ld   ($8846),hl
254F: 22 40 88      ld   ($8840),hl
2552: 21 E2 88      ld   hl,$8842
...
2560: 21 F3 80      ld   hl,$885B
2563: 3E E9         ld   a,$41
2565: CD 81 8D      call $2589
2568: 21 D5 80      ld   hl,$8855
256B: 3E CB         ld   a,$4B
256D: CD 81 8D      call $2589
2570: 21 C7 88      ld   hl,$884F
2573: 3E 49         ld   a,$49
2575: CD 89 25      call $2589
2578: 21 C1 88      ld   hl,$8849
257B: 3E 52         ld   a,$52
257D: CD 89 25      call $2589
2580: 21 C3 80      ld   hl,$8843
2583: 3E E9         ld   a,$41
2585: CD 81 8D      call $2589
2588: C9            ret
2589: 77            ld   (hl),a
258A: 23            inc  hl
258B: 77            ld   (hl),a
...
258D: 77            ld   (hl),a
258E: C9            ret
258F: CD 48 26      call $2648
2592: 3A D7 88      ld   a,($885F)
2595: FE 06         cp   $06
2597: C8            ret  z
...
2616: 16 20         ld   d,$00
2618: 5F            ld   e,a
2619: 21 43 A8      ld   hl,$8843
261C: 19            add  hl,de
261D: E5            push hl
261E: CD EF 26      call $26CF
2621: E1            pop  hl
2622: 3A D6 88      ld   a,($885E)
2625: 77            ld   (hl),a
2626: 23            inc  hl
2627: DD 23         inc  ix
2629: FD 23         inc  iy
...
264D: CD 8D 26      call $268D
2650: 2A 60 88      ld   hl,($8840)
2653: CD 99 85      call $2D99
2656: D0            ret  nc
2657: 3E 05         ld   a,$05
2659: 32 5F A8      ld   ($885F),a
265C: 2A 66 88      ld   hl,($8846)
265F: CD 99 05      call $2D99
2662: D0            ret  nc
2663: 3E 2C         ld   a,$04
2665: 32 FF 88      ld   ($885F),a
2668: 2A C4 88      ld   hl,($884C)
266B: CD 99 05      call $2D99
266E: D0            ret  nc
266F: 3E 03         ld   a,$03
2671: 32 5F A8      ld   ($885F),a
2674: 2A 72 88      ld   hl,($8852)
2677: CD 99 85      call $2D99
267A: D0            ret  nc
267B: 3E 02         ld   a,$02
267D: 32 5F A8      ld   ($885F),a
2680: 2A D0 88      ld   hl,($8858)
2683: CD 99 05      call $2D99
2686: D0            ret  nc
2687: 3E 29         ld   a,$01
...
2698: C9            ret
2699: ED 5B A6 88   ld   de,($880E)
269D: C9            ret
269E: 11 60 88      ld   de,$8840
26A1: 21 6E 88      ld   hl,$8846
26A4: 3A D7 88      ld   a,($885F)
26A7: 47            ld   b,a
26A8: 3E A5         ld   a,$05
26AA: 90            sub  b
...
26CE: C9            ret
26CF: 3E 10         ld   a,$10
26D1: 32 02 A8      ld   ($8802),a
26D4: 21 F6 88      ld   hl,$885E
26D7: 36 41         ld   (hl),$41
...
271C: 06 B0         ld   b,$10
271E: 3A 25 80      ld   a,($8825)
2721: CB 5F         bit  3,a
2723: 20 AA         jr   nz,$2727
2725: 06 BE         ld   b,$16
2727: 78            ld   a,b
2728: 32 82 80      ld   ($8802),a
272B: CD FE 8F      call $2756
272E: 18 44         jr   $26F4
2730: 21 D6 88      ld   hl,$885E
2733: 35            dec  (hl)
2734: 3E E0         ld   a,$40
2736: BE            cp   (hl)
...
2746: 36 C1         ld   (hl),$41
2748: 18 27         jr   $26D9
274A: CD CB 2F      call $2763
274D: 3E 98         ld   a,$18
274F: 32 02 88      ld   ($8802),a
2752: CD F6 27      call $2756
2755: C9            ret
2756: DD E5         push ix
2758: E1            pop  hl
...
2768: FD E5         push iy
276A: 18 6C         jr   $2758
276C: 21 5F 2F      ld   hl,$27F7
276F: 06 02         ld   b,$02
2771: CD F4 01      call print_line_29F4
2774: 10 5B         djnz $2771
2776: 21 E5 28      ld   hl,$2845
2779: 06 06         ld   b,$06
277B: CD F4 01      call print_line_29F4
277E: 10 5B         djnz $277B
2780: 3E 91         ld   a,$11
2782: 32 82 80      ld   ($8802),a
2785: 11 AE A6      ld   de,$0E06
2788: 21 F0 80      ld   hl,$8858
278B: CD 33 8F      call $27B3
278E: 11 86 11      ld   de,$1106
2791: 21 52 88      ld   hl,$8852
2794: CD 3B 27      call $27B3
2797: 11 06 B4      ld   de,$1406
279A: 21 C4 88      ld   hl,$884C
279D: CD B3 27      call $27B3
27A0: 11 86 BF      ld   de,$1706
27A3: 21 EE 20      ld   hl,$8846
27A6: CD 1B 2F      call $27B3
...
27D3: 26 00         ld   h,$00
27D5: 6F            ld   l,a
27D6: CD E0 2B      call $2B40
27D9: CD 6F 04      call $2C6F
27DC: 06 A5         ld   b,$05
27DE: CD A0 09      call $2900
...
27FE: 59            ld   e,c
27FF: 16 7B         ld   d,$53
2801: 20 20         jr   nz,$2823
2803: E2 6D F3      jp   po,$5345
2806: 7C            ld   a,h
2807: 20 15         jr   nz,$27BE
2809: A7            and  a
280A: 2D            dec  l
280B: B0            or   b
280C: EC C1 7B      call pe,$5349
280F: F4 20 E7      call p,$4F20
2812: 46            ld   b,(hl)
2813: 00            nop
2814: 50            ld   d,b
2815: E4 41 F1      call po,$5941
2818: 45            ld   b,l
2819: 7A            ld   a,d
281A: 05            dec  b
281B: 22 18 65      ld   ($4518),hl
281E: 4E            ld   c,(hl)
281F: 74            ld   (hl),h
2820: 6D            ld   l,l
2821: F2 20 D1      jp   p,$5920
2824: EF            rst  $28
2825: F5            push af
2826: 7A            ld   a,d
2827: 20 E9         jr   nz,$2872
2829: C6 E9         add  a,$49
282B: F4 E9 E1      call p,$4149
282E: EC FB 07      call pe,$07D3
2831: 24            inc  h
2832: 17            rla
2833: 73            ld   (hl),e
2834: 43            ld   b,e
...
2836: 52            ld   d,d
2837: 65            ld   h,l
2838: 20 00         jr   nz,$285A
283A: 20 61         jr   nz,$287D
283C: 43            ld   b,e
283D: 74            ld   (hl),h
283E: 20 00         jr   nz,$2860
2840: 20 C6         jr   nz,$2890
2842: 69            ld   l,c
2843: C5            push bc
2844: 4D            ld   c,l
2845: A7            and  a
...
2849: E3            ex   (sp),hl
284A: EF            rst  $28
284B: F2 6D 20      jp   p,$2045
284E: 20 20         jr   nz,$2870
2850: 41            ld   b,c
2851: 63            ld   h,e
2852: 54            ld   d,h
2853: 00            nop
2854: 20 00         jr   nz,$2876
2856: 4E            ld   c,(hl)
2857: 61            ld   h,c
2858: 4D            ld   c,l
2859: 6D            ld   l,l
285A: 02            ld   (bc),a
285B: A6            and  (hl)
285C: 11 11 53      ld   de,$5331
285F: 7C            ld   a,h
2860: 2A B1 39      ld   hl,($1111)
2863: 32 EE EC      ld   ($C44E),a
2866: 2A B4 39      ld   hl,($1114)
2869: 33            inc  sp
286A: 7A            ld   a,d
286B: EC 2A B7      call pe,$1702
286E: 39            add  hl,sp
286F: 34            inc  (hl)
2870: 54            ld   d,h
2871: E8            ret  pe
...
28BE: 19            add  hl,de
28BF: 22 38 88      ld   ($8810),hl
28C2: CD 24 A4      call $2C24
28C5: C9            ret
28C6: 2A 86 88      ld   hl,($880E)
28C9: 19            add  hl,de
28CA: 22 86 88      ld   ($880E),hl
28CD: CD 86 03      call $2BAE
28D0: C9            ret
...
2948: F1            pop  af
2949: 77            ld   (hl),a
294A: 3A 82 80      ld   a,($8802)
294D: E6 9F         and  $1F
294F: 11 00 A4      ld   de,$0400
2952: 19            add  hl,de
2953: 77            ld   (hl),a
2954: 79            ld   a,c
2955: 3C            inc  a
...
296F: 78            ld   a,b
2970: FE 20         cp   $20
2972: 30 B5         jr   nc,$2989
2974: 79            ld   a,c
2975: FE 1C         cp   $1C
2977: 30 39         jr   nc,$29B2
2979: 87            add  a,a
297A: 16 A0         ld   d,$00
297C: 5F            ld   e,a
...
299D: 21 C2 AB      ld   hl,$83C2
29A0: CB 47         bit  0,a
29A2: 28 83         jr   z,$29A7
29A4: 21 4A A3      ld   hl,$83E2
29A7: 3E 9B         ld   a,$1B
29A9: B9            cp   c
...
2A5A: 21 FC 2A      ld   hl,$2ADC
2A5D: CD F4 81      call print_line_29F4
2A60: 21 7B A2      ld   hl,$2AF3
...
2BD2: CD 99 2D      call $2D99
2BD5: D0            ret  nc
2BD6: ED 53 0C 88   ld   ($880C),de
2BDA: CD BB 2B      call $2B93
2BDD: C9            ret
2BDE: 21 B4 80      ld   hl,lives_counter_p1_8814
2BE1: CB 7E         bit  7,(hl)
2BE3: C0            ret  nz
2BE4: E5            push hl
2BE5: 2A 8E 20      ld   hl,($880E)
2BE8: 11 38 8B      ld   de,$0BB8
2BEB: 3A E8 10      ld   a,(dip_switches_9040)
2BEE: CB 47         bit  0,a
2BF0: 28 A3         jr   z,$2BF5
2BF2: 11 88 13      ld   de,$1388
2BF5: CD 99 05      call $2D99
2BF8: E1            pop  hl
2BF9: D8            ret  c
2BFA: 34            inc  (hl)
2BFB: CB FE         set  7,(hl)
...
2C0B: C0            ret  nz
2C0C: E5            push hl
2C0D: 2A 38 88      ld   hl,($8810)
2C10: 11 98 0B      ld   de,$0BB8
2C13: 3A 40 38      ld   a,(dip_switches_9040)
2C16: CB 47         bit  0,a
2C18: 28 23         jr   z,$2C1D
2C1A: 11 A8 13      ld   de,$1388
2C1D: CD 99 85      call $2D99
2C20: E1            pop  hl
2C21: D8            ret  c
2C22: 18 FE         jr   $2BFA
2C24: 2A B0 88      ld   hl,($8810)
...
2D8E: EB            ex   de,hl
	...
	;; kinds of emulates jmp (de,a*2) 68k instruction
	;; < de:	jump table
	;; < a:	index
indirect_jump_2D8F: 26 00         ld   h,$00
2D91: 6F            ld   l,a
2D92: 29            add  hl,hl
2D93: 19            add  hl,de
2D94: 5E            ld   e,(hl)
...
2E28: 3E B0         ld   a,$10
2E2A: 32 A2 88      ld   ($8802),a
2E2D: CD 12 07      call compute_eggs_locations_2FB2
2E30: 3E A1         ld   a,$09
2E32: 32 22 88      ld   ($8802),a
...
2E55: 
	dc.w	00_path_draw_up_3040
	dc.w	01_path_draw_down_304F
	dc.w	02_path_draw_left_305E
	dc.w	03_path_draw_down_306D
...
2E63: 3E 28         ld   a,$00
2E65: 32 2A 88      ld   ($8802),a
2E68: 18 A5         jr   $2E6F
2E6A: 3E 81         ld   a,$09
2E6C: 32 A2 88      ld   ($8802),a
2E6F: 1E 10         ld   e,$10
...
2E84: 16 94         ld   d,$1C
2E86: CD 2B A6      call $2EA3
2E89: 01 28 20      ld   bc,$2000
2E8C: 16 94         ld   d,$1C
2E8E: CD 2B 2E      call $2EA3
2E91: C9            ret
...
2EA2: C9            ret
2EA3: D5            push de
2EA4: CD 47 A1      call $296F
2EA7: D1            pop  de
2EA8: 73            ld   (hl),e
2EA9: D5            push de
2EAA: 11 A0 2C      ld   de,$0400
2EAD: 19            add  hl,de
2EAE: 3A A2 88      ld   a,($8802)
2EB1: 77            ld   (hl),a
2EB2: D1            pop  de
2EB3: 0C            inc  c
2EB4: 15            dec  d
2EB5: 20 EC         jr   nz,$2EA3
2EB7: C9            ret
2EB8: D5            push de
2EB9: CD 6F 81      call $296F
2EBC: D1            pop  de
2EBD: 73            ld   (hl),e
2EBE: D5            push de
2EBF: 11 28 A4      ld   de,$0400
2EC2: 19            add  hl,de
2EC3: 3A 2A 88      ld   a,($8802)
2EC6: 77            ld   (hl),a
2EC7: D1            pop  de
2EC8: 04            inc  b
2EC9: 15            dec  d
...
2F68: 50            ld   d,b
2F69: 59            ld   e,c
2F6A: CD 31 0D      call $2D99
2F6D: 28 73         jr   z,$2F62
2F6F: 2A B2 8D      ld   hl,($8DB2)
2F72: CD 99 2D      call $2D99
...
is_way_up_clear_308E
	: ED 4B 20 04   ld   bc,(maze_data_8C20)
3092: 04            inc  b
3093: CD CA B8      call is_way_clear_30CA
3096: C9            ret
	
is_way_down_clear_3097: ED 4B A8 8C   ld   bc,(maze_data_8C20)
309B: 05            dec  b
309C: 18 F5         jr   $3093
	
is_way_left_clear_309E: ED 4B 08 A4   ld   bc,(maze_data_8C20)
30A2: 0D            dec  c
30A3: 18 EE         jr   $3093
	
is_way_right_clear_30A5: ED 4B 08 A4   ld   bc,(maze_data_8C20)
30A9: 0C            inc  c
30AA: 18 6F         jr   $3093
...
ED 4B 08 A4   ld   bc,(maze_data_8C20)
30C7: 0C            inc  c
30C8: 18 6F         jr   $30B1
...
draw_2_holes_right_3110: DD 34 02      inc  (ix+$02)
...
3168: 7E            ld   a,(hl)
3169: 2F            cpl
316A: FD 77 80      ld   (iy+$00),a
316D: 23            inc  hl
316E: CD F7 31      call $317F
...
31AC: B3            or   e
31AD: 57            ld   d,a
31AE: FD 72 00      ld   (iy+$00),d
31B1: 23            inc  hl
31B2: 7E            ld   a,(hl)
31B3: FD 77 81      ld   (iy+$01),a
31B6: C9            ret
	
31B7: 21 20 10      ld   hl,$9020
31BA: 06 90         ld   b,$10
31BC: 36 80         ld   (hl),$00
31BE: 23            inc  hl
...
31C6: DD 36 80 F0   ld   (ix+$00),$78 ; x
31CA: DD 36 81 F8   ld   (ix+$01),$70 ; y
31CE: DD 36 02 A0   ld   (ix+$02),$08 ; animation frame
31D2: DD 36 03 A3   ld   (ix+$03),$0B  ; color
31D6: DD 36 04 81   ld   (ix+$04),$01 ; looking down
31DA: DD 36 06 A2   ld   (ix+$06),$0A ;  speed (fixed)
31DE: DD 36 87 28   ld   (ix+$07),$00
31E2: DD 36 89 28   ld   (ix+$09),$00
31E6: DD 36 9E 28   ld   (ix+$1e),$00
31EA: DD 36 9F 29   ld   (ix+$1f),$01
31EE: C9            ret
init_snobee_positions_31EF:
	DD 21 80 8D   ld   ix,snobee_1_struct_8D00
...
3215: DD 7E 8E      ld   a,(ix+$06)
	;; copy speed values
3218: DD 77 1C      ld   (ix+$1c),a
321B: DD 36 8F 00   ld   (ix+$07),$00
...
322F: AF            xor  a
3230: DD 77 00      ld   (ix+$00),a
3233: DD 77 89      ld   (ix+$01),a
...
327B: FE 04         cp   $04
327D: C0            ret  nz
327E: DD 36 37 88   ld   (ix+$1f),$00
3282: C9            ret
	
init_moving_block_3283: DD 21 28 A5   ld   ix,$moving_block_struct_8DA0
3287: DD 36 88 00   ld   (ix+$00),$00
328B: DD 36 89 00   ld   (ix+$01),$00
328F: DD 36 8B 09   ld   (ix+$03),$09
3293: DD 36 8E 03   ld   (ix+$06),$03
3297: DD 36 8F 00   ld   (ix+$07),$00
329B: DD 36 9E 00   ld   (ix+$16),$00
329F: DD 36 9F 00   ld   (ix+$17),$00
32A3: DD 36 97 00   ld   (ix+$1f),$00
32A7: CD AB 11      call $39AB
32AA: C9            ret
32AB: AF            xor  a
...
3324: DD 7E 9F      ld   a,(ix+$1f)
3327: 11 AD BB      ld   de,snobee_jump_table_332D
332A: C3 07 AD      jp   indirect_jump_2D8F
	;; was encrypted in the dump because it's actually data...
snobee_jump_table_332D
	dc.w	00_snobee_do_nothing_3353
	dc.w	01_snobee_not_moving_3377
	dc.w	02_snobee_moving_33A5
	dc.w	03_snobee_aligns_for_stunned_3AAD
	dc.w	04_snobee_stunned_39B5
	dc.w	05_snobee_blinking_stunned_39F3
	dc.w	06_stunned_picked_3A6C
	3359
	3372
	3AD7
	3B46
...
3359: DD 36 80 00   ld   (ix+$00),$00
335D: DD 36 81 80   ld   (ix+$01),$00
3361: CD 4E BB      call $33CE
3364: DD 34 9F      inc  (ix+$1f)
3367: C9            ret
3368: DD 36 9F 28   ld   (ix+$1f),$00
336C: C9            ret
336D: DD 36 37 01   ld   (ix+$1f),$01
3371: C9            ret
3372: DD 36 1F A6   ld   (ix+$1f),$0E
3376: C9            ret
	
01_snobee_not_moving_3377:
	CD 57 B9      call $3957
...
3385: DD 36 22 84   ld   (ix+$0a),$04
3389: DD 36 21 8F   ld   (ix+$09),$0F
338D: C9            ret
338E: 3A AC 88      ld   a,(counter_8824)
3391: A7            and  a
3392: C0            ret  nz
3393: DD 7E A2      ld   a,(ix+$0a)
3396: 3D            dec  a
3397: 28 04         jr   z,$339D
3399: DD 77 A2      ld   (ix+$0a),a
339C: C9            ret
339D: DD 36 A1 80   ld   (ix+$09),$00
33A1: DD 34 37      inc  (ix+$1f)
33A4: C9            ret
	
02_snobee_moving_33A5:
	;; is period time reached?
	CD D7 B1      call $3957
33A8: DD 34 87      inc  (ix+$07)
33AB: DD 7E 2F      ld   a,(ix+$07)
33AE: DD BE 06      cp   (ix+$06) ;  snobee period (copied from ix+$1C)
33B1: D8            ret  c
	;; period time reached:	 time to move the snobee
33B2: DD 36 07 80   ld   (ix+$07),$00
...
33CE: DD 7E 05      ld   a,(ix+$05)
33D1: DD E5         push ix
33D3: E1            pop  hl
33D4: CD D4 31      call $3154
33D7: C9            ret
...
33E6: 3A 75 0C      ld   a,(elapsed_minutes_8C5D)
33E9: FE 82         cp   $02
...
3442: D6 89         sub  $01
3444: DD 77 34      ld   (ix+$1c),a ; change/adjust speed
3447: DD 36 96 02   ld   (ix+$1e),$02 ; breaking block mode
	
344B: 3A 75 A4      ld   a,(elapsed_minutes_8C5D)
344E: FE 89         cp   $01
...
3458: C1            pop  bc
3459: 90            sub  b
345A: DD 77 1C      ld   (ix+$1c),a ; change/adjust speed
345D: DD 36 1E 02   ld   (ix+$1e),$02 ; breaking block mode
...
3497: DD 7E 88      ld   a,(ix+$00)
349A: FE 50         cp   $D8
349C: 28 9A         jr   z,$34B0
349E: FE 18         cp   $18
34A0: 28 86         jr   z,$34B0
34A2: DD 7E 36      ld   a,(ix+$1e)
34A5: D6 21         sub  $09
34A7: E6 03         and  $03
...
34B8: C6 0D         add  a,$0D
34BA: DD 77 1E      ld   (ix+$1e),a ;  select corner to flee
34BD: E1            pop  hl
34BE: C9            ret
...
34C9: C6 25         add  a,$0D
34CB: DD 77 96      ld   (ix+$1e),a ;  select corner to flee
34CE: E1            pop  hl
34CF: C9            ret
...
34F2: C9            ret
34F3: DD 36 8A C8   ld   (ix+$02),$C8
34F7: DD 36 0B 06   ld   (ix+$0b),$06
34FB: DD 77 1C      ld   (ix+$1c),a
34FE: DD 36 9F 39   ld   (ix+$1f),$11
3502: C9            ret
...
354B: 06 81         ld   b,$01
354D: DD 7E 35      ld   a,(ix+$1d) ;  saved A.I. mode
3550: DD 77 1E      ld   (ix+$1e),a ; sets saved A.I. mode
3553: DD 7E B4      ld   a,(ix+$1c)
3556: DD 77 06      ld   (ix+$06),a
3559: DD 70 84      ld   (ix+$04),b
355C: C9            ret
355D: 06 02         ld   b,$02
355F: CB 71         bit  6,c
...
avoids_moving_block_359F: FD 21 88 0D   ld   iy,$moving_block_struct_8DA0
35A3: FD 7E 2C      ld   a,(iy+$04) ; block direction
...
snobee_threatened_by_moving_block_up_35B4:
	FD 7E 00      ld   a,(iy+$00)
35B7: DD BE 80      cp   (ix+$00)
35BA: C0            ret  nz	; not same x:	no danger
35BB: FD 7E 81      ld   a,(iy+$01)
35BE: DD BE 81      cp   (ix+$01)
...
snobee_tries_to_avoid_block_35C2: DD 7E 9E      ld   a,(ix+$1e)
35C5: DD 77 35      ld   (ix+$1d),a ; backup A.I. mode
35C8: DD 36 9E 28   ld   (ix+$1e),$00 ; set block avoidance mode
35CC: 3E 2D         ld   a,$05	; fast speed
35CE: DD 77 06      ld   (ix+$06),a ; set speed
35D1: DD 36 87 00   ld   (ix+$07),$00
35D5: E1            pop  hl
35D6: E1            pop  hl
35D7: C9            ret
	
snobee_threatened_by_moving_block_down_35D8: FD 7E 00      ld   a,(iy+$00)
35DB: DD BE 80      cp   (ix+$00)
35DE: C0            ret  nz
35DF: FD 7E 29      ld   a,(iy+$01)
35E2: DD BE 81      cp   (ix+$01)
35E5: D0            ret  nc
35E6: 18 52         jr   $snobee_tries_to_avoid_block_35C2
	
snobee_threatened_by_moving_block_left_35E8: FD 7E 81      ld   a,(iy+$01)
35EB: DD BE 29      cp   (ix+$01)
35EE: C0            ret  nz
35EF: FD 7E 80      ld   a,(iy+$00)
35F2: DD BE 00      cp   (ix+$00)
35F5: D8            ret  c
35F6: 18 62         jr   $snobee_tries_to_avoid_block_35C2
	
snobee_threatened_by_moving_block_right_35F8: FD 7E 01      ld   a,(iy+$01)
35FB: DD BE 81      cp   (ix+$01)
35FE: C0            ret  nz
35FF: FD 7E 88      ld   a,(iy+$00)
3602: DD BE 00      cp   (ix+$00)
3605: D0            ret  nc
...
3662: C3 A7 2D      jp   indirect_jump_2D8F
	...
	371D
	3752
	3655 	wrong, the others must be wrong too...
	
366F: DD 36 1E 02   ld   (ix+$1e),$02 ;  sets block breaking mode
3673: E1            pop  hl
3674: C9            ret
...
36F0: 23            inc  hl
36F1: 7E            ld   a,(hl)
36F2: DD 77 04      ld   (ix+$04),a
36F5: C9            ret
36F6: DD 7E 04      ld   a,(ix+$04)
36F9: 16 00         ld   d,$00
36FB: 5F            ld   e,a
36FC: 21 8A 37      ld   hl,$3702
36FF: 19            add  hl,de
3700: 7E            ld   a,(hl)
3701: C9            ret
3702: 81            add  a,c
3703: 28 83         jr   z,$3708
3705: 2A DD 7E      ld   hl,($565D)
3708: 90            sub  b
3709: 06 84         ld   b,$04
370B: 0E 83         ld   c,$03
370D: DD E5         push ix
...
373D: DD 46 84      ld   b,(ix+$04)
3740: DD 77 84      ld   (ix+$04),a
3743: B8            cp   b
3744: C8            ret  z
3745: DD 36 22 81   ld   (ix+$0a),$01
...
375C: DD 36 04 80   ld   (ix+$04),$00
3760: DD 7E 80      ld   a,(ix+$00)
3763: FD 96 28      sub  (iy+$00)
3766: 30 2E         jr   nc,$376E
3768: DD CB 84 4E   set  0,(ix+$04)
376C: ED 44         neg
376E: 47            ld   b,a
376F: DD 7E 81      ld   a,(ix+$01)
3772: FD 96 01      sub  (iy+$01)
3775: 30 06         jr   nc,$377D
3777: DD CB 84 CE   set  1,(ix+$04)
377B: ED 44         neg
377D: 90            sub  b
377E: 30 85         jr   nc,$3785
3780: DD CB 84 46   set  1,(ix+$04)
3784: C9            ret
3785: DD CB 2C BE   srl  (ix+$04)
3789: C9            ret
...
37F2: 04            inc  b
37F3: DD 70 84      ld   (ix+$04),b ;  set left or right to be closer to pengo
...
388A: DD 36 04 88   ld   (ix+$04),$00 ; set direction up (clear)
388E: DD 7E 00      ld   a,(ix+$00)
3891: 93            sub  e
3892: 30 8E         jr   nc,$389A
3894: DD CB 04 C6   set  0,(ix+$04) ; set direction down
3898: ED 44         neg
389A: 47            ld   b,a
389B: DD 7E 89      ld   a,(ix+$01)
389E: 92            sub  d
389F: 30 06         jr   nc,$38A7
38A1: DD CB 8C E6   set  1,(ix+$04) ; set direction left or right (depends on above)
38A5: ED 44         neg
38A7: 90            sub  b
38A8: 30 8E         jr   nc,$38B0
38AA: DD CB 04 E6   set  1,(ix+$04)
38AE: 18 8C         jr   $38B4
38B0: DD CB 04 3E   srl  (ix+$04)
...
38ED: FE 16         cp   $16
38EF: D8            ret  c
38F0: DD 7E 1C      ld   a,(ix+$1c)
38F3: C6 18         add  a,$18
38F5: DD 77 8E      ld   (ix+$06),a
38F8: CD 78 43      call $4378
38FB: CD 6F 29      call $296F
38FE: 3E 1C         ld   a,$1C
3900: BE            cp   (hl)
...
is_upper_grid_free_390F: 05            dec  b
3910: CD EF 29      call $296F
3913: 7E            ld   a,(hl)
3914: FE 88         cp   $20
3916: C9            ret
	
is_lower_grid_free_3917: 04            inc  b
3918: 04            inc  b
3919: 18 F5         jr   $3910
is_left_grid_free_391B: 0D            dec  c
391C: 18 5A         jr   $3910
is_right_grid_free_391E: 0C            inc  c
391F: 0C            inc  c
3920: 18 C6         jr   $3910
	
snobee_try_to_move_up_3922: DD 7E 81      ld   a,(ix+$01)
3925: FE 91         cp   $11
3927: D8            ret  c
3928: DD 35 81      dec  (ix+$01)
392B: C9            ret
	
snobee_try_to_move_down_392C: DD 7E 81      ld   a,(ix+$01)
392F: FE F0         cp   $F0
3931: D0            ret  nc
3932: DD 34 01      inc  (ix+$01)
3935: C9            ret
	
snobee_try_to_move_left_3936: DD 7E 00      ld   a,(ix+$00)
3939: FE 19         cp   $19
393B: D8            ret  c
393C: DD 35 00      dec  (ix+$00)
393F: C9            ret
	
snobee_try_to_move_right_3940: DD 7E 80      ld   a,(ix+$00)
3943: FE 58         cp   $D8
3945: D0            ret  nc
3946: DD 34 80      inc  (ix+$00)
3949: C9            ret
	
animate_pengo_39A4: DD 7E 88      ld   a,(ix+$08)
394D: A7            and  a
394E: C8            ret  z	; returns if a == 0
394F: 3A 24 20      ld   a,(counter_8824)
3952: E6 B7         and  $1F
3954: C0            ret  nz	; returns if counter_8824 isn't dividable by 32?
...
395A: A7            and  a
395B: C8            ret  z
395C: 3A 8C 88      ld   a,(counter_8824)
395F: E6 9F         and  $1F
3961: C0            ret  nz
...
396B: 06 80         ld   b,$00
396D: DD 7E 2D      ld   a,(ix+$05)
3970: FE 85         cp   $05
3972: 28 91         jr   z,$3985
3974: 06 8E         ld   b,$26
3976: DD 7E 1E      ld   a,(ix+$1e)
3979: FE 02         cp   $02
...
3999: CB 27         sla  a
399B: CB 27         sla  a
399D: DD 77 82      ld   (ix+$02),a
39A0: DD 7E 84      ld   a,(ix+$04)
39A3: FE 83         cp   $03
39A5: 20 84         jr   nz,$39AB
39A7: DD CB 2A 4E   set  1,(ix+$02)
39AB: DD 7E 2D      ld   a,(ix+$05)
39AE: DD E5         push ix
39B0: E1            pop  hl
39B1: CD 8A 99      call $318A
39B4: C9            ret
...
39C3: DD 36 22 85   ld   (ix+$0a),$05
39C7: DD 36 21 8F   ld   (ix+$09),$0F
39CB: 06 86         ld   b,$06
39CD: CD 47 30      call $18C7
39D0: C9            ret
39D1: 3A 24 20      ld   a,(counter_8824)
39D4: E6 FF         and  $7F
39D6: C0            ret  nz
...
39E2: 3E EC         ld   a,$64
39E4: DD CB 84 6E   bit  0,(ix+$04)
39E8: 28 2A         jr   z,$39EC
39EA: CB CF         set  1,a
39EC: DD 77 82      ld   (ix+$02),a
39EF: CD AB B9      call $39AB
39F2: C9            ret
...
3A01: DD 36 82 20   ld   (ix+$0a),$08
3A05: DD 36 81 27   ld   (ix+$09),$0F
3A09: C9            ret
3A0A: 3A 0C A0      ld   a,(counter_8824) ; count mask
3A0D: A7            and  a
3A0E: C0            ret  nz
3A0F: DD 7E 0A      ld   a,(ix+$0a)
3A12: 3D            dec  a
3A13: 28 19         jr   z,$3A2E ;  end of stun
3A15: DD 77 0A      ld   (ix+$0a),a
3A18: 06 09         ld   b,$09
3A1A: CB 47         bit  0,a
...
3A24: C6 89         add  a,$01
3A26: 47            ld   b,a
3A27: DD 70 8B      ld   (ix+$03),b
3A2A: CD 23 39      call $39AB
3A2D: C9            ret
	;; no longer stunned
3A2E: DD 7E 00      ld   a,(ix+$00)
3A31: 06 03         ld   b,$03
3A33: FE 18         cp   $18
...
3A59: E6 07         and  $07
3A5B: C6 01         add  a,$01
3A5D: DD 77 8B      ld   (ix+$03),a
3A60: CD 23 39      call $39AB
3A63: DD 36 96 02   ld   (ix+$1e),$02 ; wake up from "stunned" -> A.I. mode set to breaking block mode
3A67: DD 36 97 02   ld   (ix+$1f),$02 ; set state to "alive"
3A6B: C9            ret
	
06_stunned_picked_3A6C: DD CB 21 CE   bit  0,(ix+$09)
3A70: CC FF 3A      call z,$3A77
3A73: CD 92 3A      call $3A92
3A76: C9            ret
3A77: DD 36 0A 08   ld   (ix+$0a),$08
3A7B: DD 36 09 0F   ld   (ix+$09),$0F
3A7F: DD 36 8A 80   ld   (ix+$02),$80
3A83: CD AB 11      call $39AB
3A86: 11 82 00      ld   de,$000A
3A89: CD AF 00      call $28AF
3A8C: 06 8A         ld   b,$02
3A8E: CD EF 18      call $18C7
3A91: C9            ret
3A92: 3A AC 88      ld   a,(counter_8824) ;  count mask
3A95: A7            and  a
3A96: C0            ret  nz
3A97: DD 7E 0A      ld   a,(ix+$0a)
3A9A: 3D            dec  a
3A9B: 28 04         jr   z,$3AA1
3A9D: DD 77 0A      ld   (ix+$0a),a
3AA0: C9            ret
...
03_snobee_aligns_for_stunned_3AAD: DD 34 8F      inc  (ix+$07) ;  slow down
3AB0: DD 7E 07      ld   a,(ix+$07)
3AB3: DD BE 8E      cp   (ix+$06)
3AB6: D8            ret  c
3AB7: DD 36 8F 00   ld   (ix+$07),$00
3ABB: DD 7E 88      ld   a,(ix+$00)
3ABE: E6 0F         and  $0F
3AC0: FE 80         cp   $08
3AC2: 20 87         jr   nz,$3AD3
3AC4: DD 7E 01      ld   a,(ix+$01)
3AC7: E6 27         and  $0F
3AC9: 20 20         jr   nz,$3AD3
3ACB: DD 36 81 00   ld   (ix+$09),$00
3ACF: DD 34 1F      inc  (ix+$1f) ; next state (stunned)
3AD2: C9            ret
...
3AEA: 3A 2C A5      ld   a,($8DA4)
3AED: DD 77 8C      ld   (ix+$04),a
3AF0: E6 8A         and  $02
3AF2: 47            ld   b,a
3AF3: 3A A4 05      ld   a,($8DA4)
3AF6: 2F            cpl
3AF7: E6 01         and  $01
3AF9: B0            or   b
3AFA: FE 8B         cp   $03
...
3B02: 07            rlca
3B03: 07            rlca
3B04: DD 77 82      ld   (ix+$02),a
3B07: DD 7E 2C      ld   a,(ix+$04)
3B0A: FE 2A         cp   $02
3B0C: 20 2C         jr   nz,$3B12
3B0E: DD CB 02 66   set  1,(ix+$02)
3B12: DD 36 06 83   ld   (ix+$06),$03
3B16: 3A 0F 8D      ld   a,($8DA7)
3B19: DD 77 87      ld   (ix+$07),a
3B1C: CD 66 33      call $33CE
3B1F: CD 2B B1      call $39AB
...
3B4C: DD 34 87      inc  (ix+$07)
3B4F: DD 7E 87      ld   a,(ix+$07)
3B52: DD BE 06      cp   (ix+$06)
3B55: D8            ret  c
3B56: DD 36 07 80   ld   (ix+$07),$00
3B5A: CD 39 33      call $33B9
3B5D: C9            ret
3B5E: DD 7E 84      ld   a,(ix+$04)
3B61: FE 83         cp   $03
...
3B69: 07            rlca
3B6A: 07            rlca
3B6B: DD 77 2A      ld   (ix+$02),a
3B6E: DD 7E 04      ld   a,(ix+$04)
3B71: FE 03         cp   $03
3B73: 20 04         jr   nz,$3B79
3B75: DD CB 82 CE   set  1,(ix+$02)
3B79: CD AB B9      call $39AB
3B7C: C9            ret
3B7D: DD CB A1 C6   bit  0,(ix+$09)
3B81: CC 08 B3      call z,$3B88
3B84: CD 06 B3      call $338E
3B87: C9            ret
3B88: DD 36 8A 29   ld   (ix+$0a),$01
3B8C: DD 36 89 27   ld   (ix+$09),$0F
3B90: DD 7E 04      ld   a,(ix+$04)
3B93: FE 03         cp   $03
...
3B9C: 07            rlca
3B9D: 07            rlca
3B9E: DD 77 82      ld   (ix+$02),a
3BA1: DD 7E 2C      ld   a,(ix+$04)
3BA4: FE 2B         cp   $03
3BA6: 20 2C         jr   nz,$3BAC
3BA8: DD CB 82 46   set  1,(ix+$02)
3BAC: CD 83 B9      call $39AB
...
3BBE: C9            ret
3BBF: DD 36 22 84   ld   (ix+$0a),$04
3BC3: DD 36 21 8F   ld   (ix+$09),$0F
3BC7: DD 7E 32      ld   a,(ix+$1a)
3BCA: A7            and  a
3BCB: 20 8C         jr   nz,$3BD9
3BCD: DD 36 28 00   ld   (ix+$00),$00
3BD1: DD 36 81 00   ld   (ix+$01),$00
3BD5: CD CE 9B      call $33CE
3BD8: C9            ret
...
3C1A: CD 23 39      call $39AB
3C1D: C9            ret
3C1E: 84            add  a,h
3C1F: 00            nop
3C20: A4            and  h
3C21: B8            cp   b
3C22: 3A 0C A0      ld   a,(counter_8824) ;  count mask
3C25: A7            and  a
3C26: C0            ret  nz
3C27: DD 7E 82      ld   a,(ix+$0a)
3C2A: 3D            dec  a
3C2B: 28 04         jr   z,$3C31
3C2D: DD 77 82      ld   (ix+$0a),a
3C30: C9            ret
...
3C78: C5            push bc
3C79: CD C6 CA      call $42C6
3C7C: C1            pop  bc
3C7D: CD DE 3C      call $3CDE
3C80: DD 71 00      ld   (ix+$00),c
...
3C91: E6 07         and  $07
3C93: 3C            inc  a
3C94: DD 77 03      ld   (ix+$03),a ;  sets color
3C97: CD AB 39      call $39AB
3C9A: DD 7E 1C      ld   a,(ix+$1c)
...
3CAE: DD 77 1E      ld   (ix+$1e),a ; sets A.I. mode at random from 1 to 8
3CB1: DD 36 1B 14   ld   (ix+$1b),$14
3CB5: DD 34 1F      inc  (ix+$1f)
3CB8: 06 8B         ld   b,$03
3CBA: CD C7 18      call $18C7
3CBD: 21 1E 05      ld   hl,$8D1E
...
3CF5: C9            ret
3CF6: DD 36 0A 8C   ld   (ix+$0a),$04
3CFA: DD 36 09 0F   ld   (ix+$09),$0F
3CFE: C9            ret
3CFF: 3A A4 00      ld   a,(counter_8824)
3D02: E6 B7         and  $3F
3D04: C0            ret  nz
	;; counter 1 out of 64 xxx
3D05: DD 7E 22      ld   a,(ix+$0a)
3D08: 3D            dec  a
3D09: 28 84         jr   z,$3D0F
3D0B: DD 77 22      ld   (ix+$0a),a
3D0E: C9            ret
...
3D1C: DD 7E 02      ld   a,(ix+$02)
3D1F: D6 84         sub  $04
3D21: DD 77 2A      ld   (ix+$02),a
3D24: CD 83 B9      call $39AB
3D27: C9            ret
3D28: DD 34 9F      inc  (ix+$1f)
3D2B: C9            ret
3D2C: DD CB 89 6E   bit  0,(ix+$09)
3D30: CC 5E 3C      call z,$3CF6
3D33: CD 37 BD      call $3D37
3D36: C9            ret
3D37: 3A 24 20      ld   a,(counter_8824)
3D3A: E6 BF         and  $3F
3D3C: C0            ret  nz
	;; counter 1 out of 64 xxx
3D3D: DD 7E A2      ld   a,(ix+$0a)
3D40: 3D            dec  a
3D41: 28 84         jr   z,$3D47
3D43: DD 77 22      ld   (ix+$0a),a
3D46: C9            ret
...
3D54: DD 7E 02      ld   a,(ix+$02)
3D57: C6 04         add  a,$04
3D59: DD 77 82      ld   (ix+$02),a
3D5C: CD 2B 39      call $39AB
3D5F: C9            ret
3D60: DD 34 9F      inc  (ix+$1f)
3D63: 21 18 05      ld   hl,remaining_alive_snobees_8D98
3D66: 35            dec  (hl)
3D67: DD 36 28 80   ld   (ix+$00),$00
3D6B: DD 36 29 80   ld   (ix+$01),$00
3D6F: CD CE 9B      call $33CE
3D72: C9            ret
...
3D9D: C9            ret
3D9E: DD 36 8A 2A   ld   (ix+$0a),$02
3DA2: DD 36 89 27   ld   (ix+$09),$0F
3DA6: C9            ret
3DA7: 3A A4 00      ld   a,(counter_8824) ;  count mask
3DAA: A7            and  a
3DAB: C0            ret  nz
3DAC: DD 7E 8A      ld   a,(ix+$0a)
3DAF: 3D            dec  a
3DB0: 28 84         jr   z,$3DB6
3DB2: DD 77 0A      ld   (ix+$0a),a
3DB5: C9            ret
3DB6: DD 36 09 80   ld   (ix+$09),$00
3DBA: DD 36 1F 82   ld   (ix+$1f),$02
3DBE: C9            ret
	
pengo_nominal_move_3DBF: DD 21 08 0D   ld   ix,pengo_struct_8D80
3DC3: CD CA B1      call $animate_pengo_39A4
3DC6: DD 34 87      inc  (ix+$07)
3DC9: DD 7E 2F      ld   a,(ix+$07)
3DCC: DD BE 86      cp   (ix+$06)
3DCF: D8            ret  c
	;; can move
3DD0: DD 36 07 80   ld   (ix+$07),$00
3DD4: CD 86 3E      call $3E06
3DD7: 21 E4 BD      ld   hl,$3DE4
3DDA: E5            push hl
3DDB: DD 7E 84      ld   a,(ix+$04)
3DDE: 11 6E BD      ld   de,$3DEE
3DE1: C3 0F A5      jp   indirect_jump_2D8F
3DE4: DD 7E 85      ld   a,(ix+$05)
3DE7: DD E5         push ix
3DE9: E1            pop  hl
3DEA: CD 7C B1      call $3154
3DED: C9            ret
3DEE: 76            halt
3DEF: B5            or   l
3DF0: FA BD FE      jp   m,$FE3D
3DF3: BD            cp   l
3DF4: 02            ld   (bc),a
3DF5: BE            cp   (hl)
	;; movement table
	;; pengo go up
3DF6: DD 35 01      dec  (ix+$01)
3DF9: C9            ret
;; pengo goes down
3DFA: DD 34 01      inc  (ix+$01)
3DFD: C9            ret
;; pengo goes left
3DFE: DD 35 00      dec  (ix+$00)
3E01: C9            ret
	;; pengo goes right
3E02: DD 34 00      inc  (ix+$00)
3E05: C9            ret
	
3E06: DD 7E 00      ld   a,(ix+$00)
3E09: E6 27         and  $0F
3E0B: FE 20         cp   $08
3E0D: 20 07         jr   nz,$3E16
3E0F: DD 7E 89      ld   a,(ix+$01)
3E12: E6 0F         and  $0F
...
3E3B: 3E 6F         ld   a,$6F
3E3D: 3E 05         ld   a,$05
3E3F: CD 44 16      call $3E44
3E42: C0            ret  nz
3E43: 0C            inc  c
3E44: CD 47 29      call $296F
3E47: 7E            ld   a,(hl)
3E48: FE 08         cp   $20
3E4A: C8            ret  z
3E4B: FE 80         cp   $80
...
3E5E: 04            inc  b
3E5F: 04            inc  b
3E60: CD CC 3E      call $3E44
3E63: C0            ret  nz
3E64: 0C            inc  c
3E65: 18 F5         jr   $3E44
3E67: 0D            dec  c
3E68: CD CC 3E      call $3E44
3E6B: C0            ret  nz
3E6C: 04            inc  b
3E6D: 18 D5         jr   $3E44
3E6F: 0C            inc  c
3E70: 0C            inc  c
3E71: CD 44 3E      call $3E44
3E74: C0            ret  nz
3E75: 04            inc  b
3E76: 18 44         jr   $3E44
	
get_div8_ix_coords_3E78: DD 7E 00      ld   a,(ix+$00)
3E7B: CB 3F         srl  a
3E7D: CB 3F         srl  a
3E7F: CB 3F         srl  a
3E81: D6 02         sub  $02
3E83: 4F            ld   c,a
3E84: DD 7E 01      ld   a,(ix+$01)
3E87: CB 3F         srl  a
3E89: CB 3F         srl  a
3E8B: CB 3F         srl  a
3E8D: 47            ld   b,a
...
3EA9: A7            and  a
3EAA: C8            ret  z
3EAB: CD FB 02      call $2AFB
3EAE: 2F            cpl
3EAF: E6 0F         and  $0F
3EB1: C8            ret  z
3EB2: 06 8C         ld   b,$04
3EB4: 0F            rrca
3EB5: 38 03         jr   c,$3EBA
3EB7: 10 FB         djnz $3EB4
3EB9: C9            ret
3EBA: 3E 8C         ld   a,$04
3EBC: 90            sub  b
3EBD: DD BE 8C      cp   (ix+$04)
3EC0: C8            ret  z
3EC1: DD 7E 88      ld   a,(ix+$00)
3EC4: E6 87         and  $0F
3EC6: FE 80         cp   $08
...
3ED6: 06 8A         ld   b,$02
3ED8: DD 70 04      ld   (ix+$04),b
3EDB: C9            ret
3EDC: DD 7E 01      ld   a,(ix+$01)
3EDF: E6 27         and  $0F
3EE1: FE 04         cp   $04
...
3F1B: 3E 04         ld   a,$04
3F1D: 90            sub  b
3F1E: DD 77 84      ld   (ix+$04),a
3F21: CB DF         set  3,a
3F23: 32 74 04      ld   ($8CF4),a
3F26: C9            ret
3F27: 2A 72 04      ld   hl,($8CF2)
3F2A: 11 DD 0C      ld   de,$8CF5
3F2D: EB            ex   de,hl
3F2E: 1A            ld   a,(de)
3F2F: CB 46         bit  0,(hl)
3F31: 28 09         jr   z,$3F3C
3F33: 13            inc  de
3F34: ED 53 F2 24   ld   ($8CF2),de
3F38: 0F            rrca
3F39: 0F            rrca
3F3A: 0F            rrca
3F3B: 0F            rrca
...
3F5C: 2A 5A 8C      ld   hl,($8CF2)
3F5F: 11 75 04      ld   de,$8CF5
3F62: EB            ex   de,hl
3F63: 3A 74 04      ld   a,($8CF4)
3F66: CB 46         bit  0,(hl)
...
3FEC: 11 DA BF      ld   de,$3FF2
3FEF: C3 8F AD      jp   indirect_jump_2D8F
3FF2: FA BF 23      jp   m,$233F
3FF5: C0            ret  nz
3FF6: 1F            rra
3FF7: C0            ret  nz
3FF8: 4E            ld   c,(hl)
...
4008: 07            rlca
4009: 07            rlca
400A: DD 77 2A      ld   (ix+$02),a
400D: DD 7E A4      ld   a,(ix+$04)
4010: FE 23         cp   $03
4012: 20 24         jr   nz,$4018
4014: DD CB 02 EE   set  1,(ix+$02)
4018: CD 8B 39      call $39AB
...
402D: C9            ret
402E: DD 36 0A 21   ld   (ix+$0a),$01
4032: DD 36 09 A7   ld   (ix+$09),$0F
4036: C9            ret
4037: 3A 24 A8      ld   a,(counter_8824) ; count mask
403A: A7            and  a
403B: C0            ret  nz
403C: DD 7E 0A      ld   a,(ix+$0a)
403F: 3D            dec  a
4040: 28 A4         jr   z,$4046
4042: DD 77 AA      ld   (ix+$0a),a
4045: C9            ret
4046: DD 36 A9 A0   ld   (ix+$09),$00
404A: DD 34 AB      inc  (ix+$0b)
404D: C9            ret
404E: DD 36 1F 22   ld   (ix+$1f),$02
4052: C9            ret
4053: DD 7E A3      ld   a,(ix+$0b)
4056: 11 F4 40      ld   de,$405C
4059: C3 8F 85      jp   indirect_jump_2D8F
405C: FA 97 6E      jp   m,$6E3F
405F: 60            ld   h,b
4060: BF            cp   a
4061: E0            ret  po
4062: E6 E0         and  $40
4064: D2 17 E6      jp   nc,$6E3F
4067: E0            ret  po
4068: BF            cp   a
4069: E0            ret  po
406A: E6 E0         and  $40
...
4078: C9            ret
4079: DD 36 A2 02   ld   (ix+$0a),$02
407D: DD 36 A1 AF   ld   (ix+$09),$0F
4081: C9            ret
4082: 3A 24 88      ld   a,(counter_8824)
4085: E6 BF         and  $1F
4087: C0            ret  nz
	;; counter 1 out of 32 pengo breaks block
4088: DD 7E AA      ld   a,(ix+$0a)
408B: 3D            dec  a
408C: 28 A4         jr   z,$4092
408E: DD 77 0A      ld   (ix+$0a),a
4091: C9            ret
4092: DD 36 09 20   ld   (ix+$09),$00
4096: DD 34 0B      inc  (ix+$0b)
4099: C9            ret
409A: DD 7E 0B      ld   a,(ix+$0b)
409D: 11 A3 60      ld   de,$40A3
...
snobee_on_waving_edge_4184: DD 4E A8      ld   c,(ix+$00)
4187: DD 46 81      ld   b,(ix+$01)
418A: DD 7E 9F      ld   a,(ix+$1f)
418D: A7            and  a
418E: C8            ret  z
418F: FE 02         cp   $02
4191: C0            ret  nz
4192: 3A AC 8D      ld   a,($8D84)
4195: 11 9B E1      ld   de,$419B
4198: C3 8F 2D      jp   indirect_jump_2D8F
419B: 2B            dec  hl
419C: 41            ld   b,c
419D: 0C            inc  c
419E: 41            ld   b,c
419F: 3A E9 38      ld   a,($B841)
41A2: E9            jp   (hl)
41A3: 3E B8         ld   a,$10
41A5: B8            cp   b
41A6: C0            ret  nz
41A7: DD 36 B7 AB   ld   (ix+$1f),$03
41AB: C9            ret
41AC: 3E 58         ld   a,$F0
41AE: B8            cp   b
41AF: C0            ret  nz
...
pengo_block_push_41BE: DD 21 20 25   ld   ix,$moving_block_struct_8DA0
41C2: 11 63 E9      ld   de,$41CB
41C5: DD 7E B7      ld   a,(ix+$1f)
...
422C: 07            rlca
422D: 4F            ld   c,a
422E: DD 7E 04      ld   a,(ix+$04)
4231: FD E5         push iy
4233: DD E1         pop  ix
4235: DD 77 24      ld   (ix+$04),a
4238: DD 71 00      ld   (ix+$00),c
423B: DD 70 21      ld   (ix+$01),b
...
424D: 3E 74         ld   a,$74
424F: DD 77 22      ld   (ix+$02),a
4252: CD 8B 39      call $39AB
4255: DD 34 B7      inc  (ix+$1f)
4258: 06 25         ld   b,$05
...
4275: DD 36 B7 02   ld   (ix+$1f),$02
4279: FD E5         push iy
427B: DD E1         pop  ix
427D: DD 36 B7 28   ld   (ix+$1f),$00
4281: C9            ret
4282: DD 36 BF A5   ld   (ix+$1f),$05
4286: FD E5         push iy
4288: DD E1         pop  ix
428A: DD 36 BF A0   ld   (ix+$1f),$00
428E: 06 A3         ld   b,$03
4290: CD 8F 18      call $18AF
4293: C9            ret
4294: DD 36 1F 24   ld   (ix+$1f),$04
4298: FD CB 18 46   bit  4,(iy+$18)
429C: 28 25         jr   z,$42A3
429E: FD 36 BF A0   ld   (iy+$1f),$00
42A2: C9            ret
42A3: CD F0 E3      call $4378
42A6: FD E5         push iy
42A8: DD E1         pop  ix
42AA: DD 36 BF A0   ld   (ix+$1f),$00
42AE: C5            push bc
42AF: 06 02         ld   b,$02
42B1: CD AF B0      call $18AF
42B4: C1            pop  bc
42B5: CD C6 62      call $42C6
42B8: CB EE         set  5,(hl)
42BA: CB 76         bit  6,(hl)
42BC: C8            ret  z
...
42F9: 60            ld   h,b
42FA: 69            ld   l,c
42FB: ED 5B 18 8D   ld   de,($8DB0)
42FF: CD 91 AD      call $2D99
4302: C8            ret  z
4303: FD 34 B0      inc  (iy+$18)
4306: ED 5B 32 25   ld   de,($8DB2)
430A: CD 31 0D      call $2D99
430D: C8            ret  z
430E: FD 34 18      inc  (iy+$18)
4311: ED 5B 3C 8D   ld   de,($8DB4)
4315: CD 99 05      call $2D99
4318: C8            ret  z
4319: C9            ret
431A: 22 E3 37      ld   ($3743),hl
431D: E3            ex   (sp),hl
431E: 4D            ld   c,l
431F: E3            ex   (sp),hl
4320: 6A            ld   l,d
4321: C3 05 CD      jp   $65AD
4324: 4F            ld   c,a
4325: A9            xor  c
4326: 3E B2         ld   a,$1A
4328: BE            cp   (hl)
...
43B6: CD A0 29      call $2900
43B9: CD 00 01      call $2900
43BC: C9            ret
43BD: DD 34 A7      inc  (ix+$07)
43C0: DD 7E AF      ld   a,(ix+$07)
43C3: DD BE 86      cp   (ix+$06)
43C6: D8            ret  c
43C7: DD 36 87 A8   ld   (ix+$07),$00
...
43DE: DD E5         push ix
43E0: E1            pop  hl
43E1: CD FC 99      call $3154
43E4: C9            ret
	
43E5: DD 7E 80      ld   a,(ix+$00)
43E8: E6 A7         and  $0F
43EA: FE A0         cp   $08
43EC: C0            ret  nz
43ED: DD 7E 81      ld   a,(ix+$01)
43F0: E6 87         and  $0F
43F2: C0            ret  nz
...
check_snobee_collisions_with_block_4431
	: FD 21 20 8D   ld   iy,snobee_1_struct_8D00
...
4456: DD 7E 04      ld   a,(ix+$04) ; moving block direction (ix contains block struct)
4459: 11 5F 64      ld   de,$445F_table
445C: C3 AF 2D      jp   indirect_jump_2D8F
445F_table
	dc.w	4467		; "go up" test
	dc.w	448E		; "go down" test
...
44E9: CD 85 12      call $03_snobee_aligns_for_stunned_3AAD
...
454F: 3E 09         ld   a,$09
4551: 32 02 88      ld   ($8802),a
4554: CD 5E 2E      call $2EFE
4557: DD 34 97      inc  (ix+$1f)
455A: 06 A4         ld   b,$04
...
4611: C9            ret
4612: ED 4B B0 AD   ld   bc,($8DB0)
4616: ED 5B B2 AD   ld   de,($8DB2)
461A: CD 82 46      call $462A
461D: C8            ret  z
461E: ED 5B 14 8D   ld   de,($8DB4)
4622: CD 02 6E      call $462A
4625: C8            ret  z
4626: ED 4B 12 8D   ld   bc,($8DB2)
462A: 26 A0         ld   h,$00
462C: 78            ld   a,b
462D: C6 2A         add  a,$02
462F: 92            sub  d
...
4695: 21 6C 67      ld   hl,$476C
4698: CD 86 0F      call $0F2E
469B: 21 79 67      ld   hl,$4779
469E: DD CB 3E 56   bit  7,(ix+$16)
46A2: 28 A3         jr   z,$46A7
46A4: 21 88 6F      ld   hl,$4788
46A7: CD 54 01      call print_line_29F4
46AA: 21 71 6F      ld   hl,$4771
...
46C0: 06 64         ld   b,$64
46C2: 21 48 2B      ld   hl,$03E8
46C5: DD CB B6 F6   bit  7,(ix+$16)
46C9: 28 2D         jr   z,$46D0
46CB: 06 32         ld   b,$32
46CD: 21 54 A1      ld   hl,$01F4
46D0: C5            push bc
46D1: E5            push hl
46D2: 78            ld   a,b
46D3: E6 03         and  $03
...
47E7: C9            ret
47E8: ED 4B 30 25   ld   bc,($8DB0)
47EC: CD 70 CB      call $4BD8
47EF: ED 4B 3A 8D   ld   bc,($8DB2)
47F3: CD D8 C3      call $4BD8
47F6: ED 4B B4 8D   ld   bc,($8DB4)
...
492F: C9            ret
4930: DD 7E 05      ld   a,(ix+$05)
4933: 11 39 C1      ld   de,$4939
...
4940: C9            ret
4941: 97            sub  a
4942: CA 8A CA      jp   z,$4A22
4945: DF            rst  $18
4946: CA 02 CA      jp   z,$4A82
4949: 46            ld   b,(hl)
494A: CA 4D CA      jp   z,$4AE5
...
4A22: 3A 24 88      ld   a,(counter_8824)
4A25: E6 AF         and  $0F
4A27: C0            ret  nz
...
4A34: 3E 30         ld   a,$10
4A36: CD 6C 4B      call $4BC4
4A39: 18 05         jr   $4A40
4A3B: 3E 0C         ld   a,$0C
4A3D: CD C4 E3      call $4BC4
...
4A82: 3A 24 88      ld   a,(counter_8824)
4A85: E6 BF         and  $1F
4A87: C0            ret  nz
	;; counter 1 out of 32 ???
...
4B14: C8            ret  z
4B15: 3A 24 88      ld   a,(counter_8824)
4B18: 47            ld   b,a
4B19: E6 3F         and  $3F
4B1B: C0            ret  nz
	;; counter 1 out of 64
...
4B69: 3A 2C 20      ld   a,(counter_8824)
4B6C: E6 A7         and  $0F
4B6E: C0            ret  nz
...
4B82: DD 77 9E      ld   (ix+$1e),a ; A.I. mode ????
4B85: CD 93 E3      call $4B9B
4B88: C9            ret
4B89: DD 36 B7 A8   ld   (ix+$1f),$00
4B8D: 3A 36 25      ld   a,($8DB6)
4B90: A7            and  a
4B91: C8            ret  z
4B92: DD 36 1F A8   ld   (ix+$1f),$80
4B96: DD 36 1E 80   ld   (ix+$1e),$08
4B9A: C9            ret
...
4C3C: 07            rlca
4C3D: 07            rlca
4C3E: DD 77 2A      ld   (ix+$02),a
4C41: CD 83 11      call $39AB
4C44: CD 9E A0      call get_nb_lives_289E
4C47: 3D            dec  a
4C48: C8            ret  z
4C49: 47            ld   b,a
4C4A: 3E 83         ld   a,$0B
4C4C: 32 A2 88      ld   ($8802),a
4C4F: 0E 2C         ld   c,$2C
