...
047A: 32 B1 88      ld   (currently_playing_8819),a			; not currently playing
...
0C60: 3E A0         ld  a,$00
06C2: 32 E3 18      ld   (flip_screen_9043),a
...
table_1B2D:
    dc.b	FF FE FD FC FB FA F9 F7 F6 F5 F4       ÿþýüûúù÷öõôË.Ë.!
